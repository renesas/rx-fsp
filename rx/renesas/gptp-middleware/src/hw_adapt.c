...
#if defined(__GNUC__) || defined(__clang__) || defined(__ICCARM__) || defined(__ARMCC_VERSION) || defined(__ICCRX__)
...
typedef struct st_ethernet_port_header_t
{
    ...
    uint32_t    control_2;
    uint16_t    type;
}ATTR_PACKED st_ethernet_port_header_t;
...
typedef struct st_ethernet_port_pdu_t
{
    ...
    uint8_t                     payload[512];
}ATTR_PACKED st_ethernet_port_pdu_t;

...

{
  ...
  #endif                               /* BSP_FEATURE_RSIP_SCE9_SUPPORTED */
...

{
    ...
    if (FSP_SUCCESS == err)
    {
        err = HW_SCE_Rsa1024ModularExponentDecryptSubAdaptor(&indata_key_type,
...

{
    ...
    /* Create storage to hold the generated OEM key index */
    sce_rsa1024_public_key_index_t formatted_rsa_public_key_output          = {0};
   ...
   #if ((0U == BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED) && (0U == BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED)) /* RSA-1024 public key wrap unsupported on RSIP-E51A */
    err =
    ...
    {
        err =
            HW_SCE_Rsa1024ModularExponentEncryptSubAdaptor((uint32_t *) &formatted_rsa_public_key_output.value,
  ...
  #endif                               /* BSP_FEATURE_RSIP_SCE9_SUPPORTED || BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED || BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED */
...

{
  ...
  #endif                               /* BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED || BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED */
                         ...
                         int exponent)
{
    ...
    else if (nbits == RSA_3072_BITS)
    {
        ...
        /* Only RSIP-E51A, RSIP-E50D supports RSA 3072 plaintext key generation */
        else
        {
    ...
    else if (nbits == RSA_4096_BITS)
    {
        ...
        /* Only RSIP-E51A, RSIP-E50D supports RSA 4096 plaintext key generation */
        else
        {
...

{
  ...
  #if (0U == BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED) && (0U == BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED) /*RSA-4096 public key wrap unsupported on RSIP-E51A & RSIP-E50D*/
    err =
        HW_SCE_GenerateOemKeyIndexPrivate(SCE_OEM_KEY_TYPE_PLAIN,
...

{
  ...
  #if (0U == BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED) && (0U == BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED) /*RSA-3072 public key wrap unsupported on RSIP-E51A & RSIP-E50D*/
    err =
        HW_SCE_GenerateOemKeyIndexPrivate(SCE_OEM_KEY_TYPE_PLAIN,
...

{
  ...
  #if (0U == BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED) && (0U == BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED) /*RSA-2048 public key wrap unsupported on RSIP-E51A & RSIP-E50D*/
    err =
        HW_SCE_GenerateOemKeyIndexPrivate(SCE_OEM_KEY_TYPE_PLAIN,
...
int mbedtls_rsa_public (mbedtls_rsa_context * ctx, const unsigned char * input, unsigned char * output)
{
    ...
    temp_E = change_endian_long(*ctx->E.p);

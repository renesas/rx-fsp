                                    ...
                                    const uint32_t * InData_S)
{
    ...
    else
    {
        ...
        p_domain_param = DomainParam_Koblitz_secp256k1;
             ...
             BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED || BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED)) /*ECC-256 public key wrap unsupported on RSIP-E51A, RSIP-E11A and RSIP-E31A, RSIP-E50D*/
                                    ...
                                    const uint32_t * InData_S)
{
 ...
 #if (0U == (BSP_FEATURE_RSIP_RSIP_E31A_SUPPORTED || BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED || \
             BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED)) /*ECC-384 public key wrap unsupported on RSIP-E51A, RSIP-E50D and RSIP-E31A*/
    /* Install the plaintext public key to get the formatted public key */
    err = HW_SCE_GenerateOemKeyIndexPrivate(SCE_OEM_KEY_TYPE_PLAIN,
                                            key_command,
                                            NULL,
                                    ...
                                    const uint32_t * InData_S)
{
  ...
  #if (0U == (BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED || BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED)) /*ECC-521 public key wrap unsupported on RSIP-E51A, RSIP-E50D*/
    /* Install the plaintext public key to get the formatted public key */
    err = HW_SCE_GenerateOemKeyIndexPrivate(SCE_OEM_KEY_TYPE_PLAIN,
                                            key_command,
                                            NULL,

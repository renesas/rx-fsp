...
typedef struct                         /*!< (@ 0x87019000) R_SYSTEM Structure                                         */
{
    ...
    union
    {
        __IOM uint8_t ESCCKDIVCR;      /*!< (@ 0x000000D7) ESC Clock Frequency Division Control Register              */

        struct
        {
#if defined(__BIG) && defined(__GNUC__)
            uint8_t                : 4;
            __IOM uint8_t ESCCKDIV : 4; /*!< [3..0] ESC Clock (ESCCLK) Frequency Division Ratio Select                 */
#else
            __IOM uint8_t ESCCKDIV : 4; /*!< [3..0] ESC Clock (ESCCLK) Frequency Division Ratio Select                 */
            uint8_t                : 4;
#endif
    ...
    union
    {
        __IOM uint8_t DSMIFCKDIVCR;    /*!< (@ 0x000000D9) DSMIF Clock Frequency Division Control Register            */

        struct
        {
#if defined(__BIG) && defined(__GNUC__)
            uint8_t                  : 4;
            __IOM uint8_t DSMIFCKDIV : 4; /*!< [3..0] DSMIF Clock (DSMIFCLK) Frequency Division Ratio Select             */
#else
            __IOM uint8_t DSMIFCKDIV : 4; /*!< [3..0] DSMIF Clock (DSMIFCLK) Frequency Division Ratio Select             */
            uint8_t                  : 4;
#endif
    ...
    union
    {
        __IOM uint8_t ESCCKCR;         /*!< (@ 0x000000DD) ESC Clock Control Register                                 */

        struct
        {
#if defined(__BIG) && defined(__GNUC__)
            __IM uint8_t  ESCCKSRDY : 1; /*!< [7..7] ESC Clock (ESCCLK) Switching Ready State Flag                      */
            __IOM uint8_t ESCCKSREQ : 1; /*!< [6..6] ESC Clock (ESCCLK) Switching Request                               */
            uint8_t                 : 2;
            __IOM uint8_t ESCCKSEL  : 4; /*!< [3..0] ESC Clock (ESCCLK) Source Select                                   */
#else
            __IOM uint8_t ESCCKSEL  : 4; /*!< [3..0] ESC Clock (ESCCLK) Source Select                                   */
            uint8_t                 : 2;
            __IOM uint8_t ESCCKSREQ : 1; /*!< [6..6] ESC Clock (ESCCLK) Switching Request                               */
    ...
    union
    {
        __IOM uint8_t DSMIFCKCR;       /*!< (@ 0x000000DF) DSMIF Clock Control Register                               */

        struct
        {
#if defined(__BIG) && defined(__GNUC__)
            __IM uint8_t  DSMIFCKSRDY : 1; /*!< [7..7] DSMIF Clock (DSMIFCLK) Switching Ready State Flag                  */
            __IOM uint8_t DSMIFCKSREQ : 1; /*!< [6..6] DSMIF Clock (DSMIFCLK) Switching Request                           */
            uint8_t                   : 2;
            __IOM uint8_t DSMIFCKSEL  : 4; /*!< [3..0] DSMIF Clock (DSMIFCLK) Source Select                               */
#else
            __IOM uint8_t DSMIFCKSEL  : 4; /*!< [3..0] DSMIF Clock (DSMIFCLK) Source Select                               */
            uint8_t                   : 2;
            __IOM uint8_t DSMIFCKSREQ : 1; /*!< [6..6] DSMIF Clock (DSMIFCLK) Switching Request                           */
...
#if defined(__BIG) && defined(__GNUC__)
            uint32_t                : 2;
            __IOM uint32_t NONSEC29 : 1; /*!< [29..29] DSMIF Clock Attribute SettingTarget: DSMIFCKDIVCR,
                                          *   DSMIFCKCR                                                                 */
            __IOM uint32_t NONSEC28 : 1; /*!< [28..28] Ethernet-PHY Clock Attribute SettingTarget: ESCCKDIVCR,
                                          *   ESCCKCR, ETHPCKDIVCR, ETHPCKCR                                            */
    ...
    union
    {
        __IOM uint16_t PRCR_S;         /*!< (@ 0x000003FA) Protect Register                                           */
    ...
    __IM uint8_t  RESERVED144;
    __IM uint16_t RESERVED145;
    __IM uint32_t RESERVED146;
    ...
    __IM uint8_t  RESERVED164;
    __IM uint16_t RESERVED165;
    ...
    __IM uint16_t RESERVED204;
    __IM uint32_t RESERVED205[42];
...
typedef struct                         /*!< (@ 0x87803000) R_MSTP Structure                                           */
{
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t MSTPC29 : 1; /*!< [29..29] EtherCAT Slave Controller Module Stop (Target module:
                                         *   ESC)                                                                      */
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t MSTPD11 : 1; /*!< [11..11] GPTW Port Output Enable Group D Module Stop (Target
                                         *   module: POEG group D)                                                     */
            uint32_t              : 1;
            __IOM uint32_t MSTPD9 : 1;  /*!< [9..9] Delta-Sigma Modulator Interface 0 Module Stop (Target
                                         *   module: DSMIF0)                                                           */
            __IOM uint32_t MSTPD8 : 1;  /*!< [8..8] Delta-Sigma Modulator Interface 1 Module Stop (Target
                                         *   module: DSMIF1)                                                           */
            uint32_t              : 1;

...
typedef struct                         /*!< (@ 0x8701D000) R_BUS Structure                                            */
{
    ...
    __IM uint32_t            RESERVED16[345];
    __IOM R_BUS_BUSERRb_Type BUSERRb[13];   /*!< (@ 0x00001800) Bus Error Registers                                        */
    __IM uint32_t            RESERVED17[140];

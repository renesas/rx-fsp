...
typedef struct                         /*!< (@ 0x87018000) R_CPSCU Structure                                          */
{
    ...
    union
    {
        __IOM uint32_t DMACSAR;        /*!< (@ 0x00000034) DMA Controller Security Attribution Register               */

        struct
        {
#if defined(__BIG) && defined(__GNUC__)
            uint32_t                : 31;
            __IOM uint32_t DMASTSA0 : 1; /*!< [0..0] DMAST Security Attribution Setting 0                               */
#else
            __IOM uint32_t DMASTSA0 : 1; /*!< [0..0] DMAST Security Attribution Setting 0                               */
            uint32_t                : 31;
#endif
...
#if defined(__BIG) && defined(__GNUC__)
            uint32_t               : 24;
            __IOM uint32_t SADMAC7 : 1; /*!< [7..7] Security Attributes of Output and Registers for DMAC7
                                         *   Channel Select                                                            */
            __IOM uint32_t SADMAC6 : 1; /*!< [6..6] Security Attributes of Output and Registers for DMAC6
                                         *   Channel Select                                                            */
            __IOM uint32_t SADMAC5 : 1; /*!< [5..5] Security Attributes of Output and Registers for DMAC5
                                         *   Channel Select                                                            */
            __IOM uint32_t SADMAC4 : 1; /*!< [4..4] Security Attributes of Output and Registers for DMAC4
                                         *   Channel Select                                                            */
            __IOM uint32_t SADMAC3 : 1; /*!< [3..3] Security Attributes of Output and Registers for DMAC3
                                         *   Channel Select                                                            */
            __IOM uint32_t SADMAC2 : 1; /*!< [2..2] Security Attributes of Output and Registers for DMAC2
                                         *   Channel Select                                                            */
            __IOM uint32_t SADMAC1 : 1; /*!< [1..1] Security Attributes of Output and Registers for DMAC1
                                         *   Channel Select                                                            */
            __IOM uint32_t SADMAC0 : 1; /*!< [0..0] Security Attributes of Output and Registers for DMAC0
                                         *   Channel Select                                                            */
#else
            __IOM uint32_t SADMAC0 : 1; /*!< [0..0] Security Attributes of Output and Registers for DMAC0
                                         *   Channel Select                                                            */

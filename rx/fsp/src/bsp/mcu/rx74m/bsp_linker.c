...
#if defined (BSP_CFG_OPTION_SETTING_BANKSEL_NS) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BLSEL_NS) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BPSD0_NS) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BLKSWP_NS) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BPS_NS) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BPS_NS_DUAL) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SOTPMS_NS) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OFS1_NS) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_PBPS_NS) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_PBPS_NS_DUAL) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_PBPSD0_NS) && !BSP_PZ_SECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_DUALSEL) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_SAS) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BANKSEL_S) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BLSEL_S) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BANKSEL_SEL) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BLSEL_SEL) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BPSD0_S) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BLKSWP_S) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BPS_S) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_BPS_S_DUAL) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_FSBLCTRL0) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_FSBLCTRL1) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_FSBLCTRL2) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SAMR) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SACC00) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SACC10) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SACC01) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SACC11) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SACC02) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SACC12) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SACC03) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SACC13) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_SOTPMS_S) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OFS0) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OFS2) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OFS1_S) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OFS1_SEL) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_PBPS_S) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_PBPS_S_DUAL) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_PBPSD0_S) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_ZHUK) && !BSP_PZ_NONSECURE_BUILD
...
#endif
#if defined (BSP_CFG_OPTION_SETTING_OTP_UMRECR) && !BSP_PZ_NONSECURE_BUILD

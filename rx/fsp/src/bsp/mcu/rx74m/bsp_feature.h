...
#define CGC_MAINCLOCK_DRIVE_RESERVED_MASK                                  (0x10UL)
#if (BSP_CFG_XTAL_HZ >= (24000000))
 #define CGC_MAINCLOCK_DRIVE                                               (0x5UL | CGC_MAINCLOCK_DRIVE_RESERVED_MASK)
#elif (BSP_CFG_XTAL_HZ >= (8000000))
 #define CGC_MAINCLOCK_DRIVE                                               (0x3UL | CGC_MAINCLOCK_DRIVE_RESERVED_MASK)
#else
 #define CGC_MAINCLOCK_DRIVE                                               (0x0UL | CGC_MAINCLOCK_DRIVE_RESERVED_MASK)
#endif

#define BSP_FEATURE_ACMPHS_IS_AVAILABLE                                    (0UL)
#define BSP_FEATURE_ACMPHS_MIN_WAIT_TIME_US                                (0UL)                   // Operation stabilization wait time.
#define BSP_FEATURE_ACMPHS_VREF                                            (0UL)                   // The IVREF selection that corresponds to the internal voltage reference.
...
#define BSP_FEATURE_ADC_IS_AVAILABLE                                       (0UL)
...
#define BSP_FEATURE_ADC_CLOCK_SOURCE                                       (0UL)                   // Clock source used for the ADC peripheral.
...
#define BSP_FEATURE_ADC_SENSOR_MIN_SAMPLING_TIME                           (0UL)                   // Minimum time, in nanoseconds, required for ADC sampling of the sensors.
...
#define BSP_FEATURE_ADC_TSN_CALIBRATION_AVAILABLE                          (0UL)                   // Determine if the temperature sensor supports calibration, either factory or runtime.
#define BSP_FEATURE_ADC_TSN_CALIBRATION32_AVAILABLE                        (0UL)                   // Determine if TSCDR is available.
#define BSP_FEATURE_ADC_TSN_CALIBRATION32_MASK                             (0x00UL)                // Create the mask for the valid calibration data provided by TSCDR.
#define BSP_FEATURE_ADC_TSN_CONTROL_AVAILABLE                              (0UL)                   // Determine if the TSCR register is present.
#define BSP_FEATURE_ADC_TSN_SLOPE                                          (4000UL)                // DEPRECATED; use BSP_FEATURE_TSN_SLOPE.
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                                    (0x00UL)                // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS                                    (0x00UL)                // Mask of available channels in ADC unit 1.
#define BSP_FEATURE_ADC_VALID_UNIT_MASK                                    (0x00UL)                // Mask of whole, physical ADC units present in the MCU.
#define BSP_FEATURE_ADC_ELC_AVAILABLE                                      (1UL)                   // Indicates the ADC can trigger ELC.
#define BSP_FEATURE_ADC_SAMPLE_HOLD_ONLY_UNIT_0                            (1UL)                   // Supports Sample Hold Circuit only on unit 0.

#define BSP_FEATURE_ADC_B_IS_AVAILABLE                                     (1UL)
#define BSP_FEATURE_ADC_B_UNIT_COUNT                                       (3UL)                   // Number of ADC_B units available in the MCU.
#define BSP_FEATURE_ADC_B_GROUP_PAIR_REGISTER_COUNT                        (6UL)                   // 12 scan groups, two groups per register.
#define BSP_FEATURE_ADC_B_START_GROUP_CONTROL_REGISTER_COUNT               (3UL)                   // Number of ADC_B Start Group Control (ADSGCR) registers.
#define BSP_FEATURE_ADC_B_PGA_CHANNEL_MASK                                 (0x00UL)                // Mask of ADC_B peripherals that support PGA.
#define BSP_FEATURE_ADC_B_PGA_SUPPORTED                                    (0UL)                   // Feature not available on this MCU
#define BSP_FEATURE_ADC_B_TSN_CALIBRATION32_MASK                           (0xFFFFUL)              // Mask of valid bits for TSN calibration.
#define BSP_FEATURE_ADC_B_TSN_SLOPE                                        (4000UL)                // DEPRECATED; use BSP_FEATURE_TSN_SLOPE.
#define BSP_FEATURE_ADC_B_SAMPLE_AND_HOLD_UNIT456_SUPPORTED                (0UL)                   // Feature not available on this MCU
#define BSP_FEATURE_ADC_B_UNIT_0_CHANNELS                                  (0x00703710000000FFULL) // Mask of channels available to ADC_B Unit 0.
#define BSP_FEATURE_ADC_B_UNIT_1_CHANNELS                                  (0x0000372FFFFFFF00ULL) // Mask of channels available to ADC_B Unit 1.
#define BSP_FEATURE_ADC_B_UNIT_2_CHANNELS                                  (0x0000374FFFFFFF00ULL) // Mask of channels available to ADC_B Unit 2.
...
#define BSP_FEATURE_AGT_AGT_CHANNEL_COUNT                                  (0UL)                   // Number of channels for only AGT (not AGTW) peripherals.
#define BSP_FEATURE_AGT_AGTW_CHANNEL_COUNT                                 (0UL)                   // Number of channels for only AGTW (not AGT) peripherals.
#define BSP_FEATURE_AGT_USE_AGTIOSEL_ALT                                   (0UL)                   // Indicates use of AGTIOSEL_ALT instead of AGTIOSEL for AGTW instances.
#define BSP_FEATURE_AGT_VALID_CHANNEL_MASK                                 (0x00UL)                // A mask of all valid AGTx channels.
...
#define BSP_FEATURE_BSP_HAS_ADC_CLOCK                                      (1UL)                   // Indicates there is a separate clock for the ADC.
...
#define BSP_FEATURE_BSP_HAS_OFS3                                           (1UL)                   // OSF3 register is available; currently only available for RA8.
...
#define BSP_FEATURE_BSP_HAS_SCI_CLOCK                                      (1UL)                   // Indicates there is a separate SCI clock.
...
#define BSP_FEATURE_BSP_HAS_SPI_CLOCK                                      (1UL)                   // Indicates there is a separate clock for the SPI.
...
#define BSP_FEATURE_BSP_HAS_USB_CLOCK_DIV                                  (1UL)                   // Indicates there is a USB clock divider setting as part of the SCKDIVCR registers.
...
#define BSP_FEATURE_BSP_MCU_INFO_POINTER_LOCATION                          (0x00UL)                // Location of the FMIFRT register.
...
#define BSP_FEATURE_BSP_MSTP_POEG_MSTPD13                                  (1UL)                   // Indicates the MSTP uses bit 13 of MSTPCRD to control the POEG.
#define BSP_FEATURE_BSP_NUM_PMSAR                                          (17UL)                  // Number of available Port Security Attribution Registers.
...
#define BSP_FEATURE_BSP_PART_NUMBER_POINTER                                (0x86C12C38UL)          // Address of the Part Numbering register (PNR).
...
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_NO_RAM_WAITS                        (150000000UL)           // The maximum frequency that can be used before wait cycles are necessary.
...
#define BSP_FEATURE_BSP_UNIQUE_ID_POINTER                                  (0x86F01000UL)          // Address of the MCU Unique ID register (UIDR).
#define BSP_FEATURE_BSP_VBATT_HAS_VBTCR1_BPWSWSTP                          (0UL)                   // VCC can switch to VBAT if the voltage drops too low.
#define BSP_FEATURE_BSP_HAS_ESCCLK_CLOCK                                   (1UL)                   // Indicates ESCCLK is available.
#define BSP_FEATURE_BSP_HAS_ETHPHYCLK_CLOCK                                (1UL)                   // Indicates ETHPHYCLK is available.

#define BSP_FEATURE_CAC_UNIT_COUNT                                         (3UL)                   // Number of CAC units.
...
#define BSP_FEATURE_CANFD_FD_SUPPORT                                       (BSP_MCU_FEATURE_SET == 'B' || \
                                                                            BSP_MCU_FEATURE_SET == 'D' || \
                                                                            BSP_MCU_FEATURE_SET == 'F')        // Flexible data rate support.
#define BSP_FEATURE_CANFD_LITE                                             (0UL)
#define BSP_FEATURE_CANFDG_NUM_CHANNELS                                    (2UL)                               // Number of CANFDG channels per CANFD peripheral instance.
...
#define BSP_FEATURE_CANFD_SUPPORT_2_TYPES                                  (1UL)                               // Support both CANFD Full and CANFD Lite on this MCU
...
#define BSP_FEATURE_CGC_HAS_PLLCR2                                         (0UL)                               // PLLCR2 register is available
...
#define BSP_FEATURE_CGC_LOW_SPEED_SUPPORT_FULL_DIVISION                    (1UL)                               // Full clock division supported in low-speed mode.
...
#define BSP_FEATURE_CGC_MODRV_MASK                                         (R_SYSTEM_MOMCR_MODRV0_Msk | \
                                                                            CGC_MAINCLOCK_DRIVE_RESERVED_MASK) // Mask used on MODRV register.
#define BSP_FEATURE_CGC_MODRV_SHIFT                                        (R_SYSTEM_MOMCR_MODRV0_Pos)         // Shift used for MODRV register.
#define BSP_FEATURE_CGC_OSTD_SUPPORT_IRQ                                   (1UL)                               // Oscillation stop detection support maskable interrupt.
#define BSP_FEATURE_CGC_OSTD_SUPPORT_NMI                                   (0UL)                               // Oscillation stop detection support non-maskable interrupt.
#define BSP_FEATURE_CGC_OSCILLATON_STOP_DETECT                             (1UL)                               // Oscillation stop detection is available.
#define BSP_FEATURE_CGC_PLL_HOCO_MAX_CPUCLK_HZ                             (600000000UL)                       // Maximum allowed clock speed when HOCO is the PLL source clock for the CPUCLK.
...
#define BSP_FEATURE_CGC_PLL_OUT_MAX_HZ                                     (600000000UL)                       // Maximum output frequency for PLL unit 1.
#define BSP_FEATURE_CGC_PLLP_OUT_MAX_HZ                                    (600000000UL)                       // Maximum output frequency for PLL out put clock P unit 1.
#define BSP_FEATURE_CGC_PLLQ_OUT_MAX_HZ                                    (500000000UL)                       // Maximum output frequency for PLL out put clock Q unit 1.
#define BSP_FEATURE_CGC_PLLR_OUT_MAX_HZ                                    (500000000UL)                       // Maximum output frequency for PLL out put clock R unit 1.
#define BSP_FEATURE_CGC_PLL_OUT_MIN_HZ                                     (60000000UL)                        // Minimum output frequency for PLL unit 1.
#define BSP_FEATURE_CGC_PLL_REFERENCE_CLK_MAX_HZ                           (24000000UL)                        // Maximum frequency of the PLL reference clock.
#define BSP_FEATURE_CGC_PLL_REFERENCE_CLK_MIN_HZ                           (8000000UL)                         // Minimum frequency of the PLL reference clock.
...
#define BSP_FEATURE_CGC_PLL2_OUT_MAX_HZ                                    (500000000UL)                       // Maximum output frequency for PLL unit 2.
...
#define BSP_FEATURE_CGC_SRAMPRCR_KW_VALUE                                  (0xA5UL)                            // Write enable key code for SRAMPRCR bit.
...
#define BSP_FEATURE_CRC_POLYNOMIAL_MASK                                    (0x3EUL)                            // Mask of available CRC polynomials; should match the mask of indexes relating to r_crc_api.h::crc_polynomial_t.
...
#define BSP_FEATURE_DAC_B_OUTPUT_ENABLE                                    (1UL)                               // DAOE bit function is available.
#define BSP_FEATURE_DAC_B_HAS_OUTPUT_AMPLIFIER                             (1UL)                               // DAAMP bit function is available.
#define BSP_FEATURE_DAC_B_HAS_VOLTAGE_MODE_SELECTION                       (0UL)                               // Feature not available on this device.
...
#define BSP_FEATURE_DAC_HAS_INTERNAL_OUTPUT                                (0UL)                               // Feature not available on this device.
...
#define BSP_FEATURE_DAC12_UNIT_COUNT                                       (2UL)                               // Feature not available on this device.

#define BSP_FEATURE_DMAC_IS_AVAILABLE                                      (1UL)
#define BSP_FEATURE_DMAC_HAS_ALL_CHANNELS_OFFSET                           (1UL)                               // All DMAC channels support offset feature
...
#define BSP_FEATURE_DMAC_GRP_IRQ_NUM_FACTORS                               (4UL)                               // Indicates the number of grouped DMAC interrupt sources.
...
#define BSP_FEATURE_ELC_HAS_ELOP                                           (1UL)                               // ELOP feature is available.
#define BSP_FEATURE_ELC_CMT1_ELOP_AVAILABLE                                (1UL)                               // ELOPA register is available.
#define BSP_FEATURE_ELC_CMTW0_ELOP_AVAILABLE                               (1UL)                               // ELOPB register is available.
#define BSP_FEATURE_ELC_TMR0_ELOP_AVAILABLE                                (1UL)                               // ELOPC register is available.
#define BSP_FEATURE_ELC_TMR1_ELOP_AVAILABLE                                (1UL)                               // ELOPC register is available.
#define BSP_FEATURE_ELC_TMR2_ELOP_AVAILABLE                                (1UL)                               // ELOPD register is available.
#define BSP_FEATURE_ELC_TMR3_ELOP_AVAILABLE                                (1UL)                               // ELOPD register is available.

/* CMT1 Operation Select Configuration (ELOPA register) */
#define BSP_FEATURE_ELC_CMT1_ELOP_REG                                      (R_ELC->ELOPA)                      // Register containing CMT1MD.
#define BSP_FEATURE_ELC_CMT1_ELOP_MASK                                     (R_ELC_ELOPA_CMT1MD_Msk)            // Mask for CMT1MD field.
#define BSP_FEATURE_ELC_CMT1_ELOP_POS                                      (R_ELC_ELOPA_CMT1MD_Pos)            // Position of CMT1MD field.

/* CMTW0 Operation Select Configuration (ELOPB register) */
#define BSP_FEATURE_ELC_CMTW0_ELOP_REG                                     (R_ELC->ELOPB)                      // Register containing CMTW0MD.
#define BSP_FEATURE_ELC_CMTW0_ELOP_MASK                                    (R_ELC_ELOPB_CMTW0MD_Msk)           // Mask for CMTW0MD field.
#define BSP_FEATURE_ELC_CMTW0_ELOP_POS                                     (R_ELC_ELOPB_CMTW0MD_Pos)           // Position of CMTW0MD field.

/* TMR0 Operation Select Configuration (ELOPC register) */
#define BSP_FEATURE_ELC_TMR0_ELOP_REG                                      (R_ELC->ELOPC)                      // Register containing TMR0MD.
#define BSP_FEATURE_ELC_TMR0_ELOP_MASK                                     (R_ELC_ELOPC_TMR0MD_Msk)            // Mask for TMR0MD field.
#define BSP_FEATURE_ELC_TMR0_ELOP_POS                                      (R_ELC_ELOPC_TMR0MD_Pos)            // Position of TMR0MD field.

/* TMR1 Operation Select Configuration (ELOPC register) */
#define BSP_FEATURE_ELC_TMR1_ELOP_REG                                      (R_ELC->ELOPC)                      // Register containing TMR1MD.
#define BSP_FEATURE_ELC_TMR1_ELOP_MASK                                     (R_ELC_ELOPC_TMR1MD_Msk)            // Mask for TMR1MD field.
#define BSP_FEATURE_ELC_TMR1_ELOP_POS                                      (R_ELC_ELOPC_TMR1MD_Pos)            // Position of TMR1MD field.

/* TMR2 Operation Select Configuration (ELOPD register) */
#define BSP_FEATURE_ELC_TMR2_ELOP_REG                                      (R_ELC->ELOPD)                      // Register containing TMR2MD.
#define BSP_FEATURE_ELC_TMR2_ELOP_MASK                                     (R_ELC_ELOPD_TMR2MD_Msk)            // Mask for TMR2MD field.
#define BSP_FEATURE_ELC_TMR2_ELOP_POS                                      (R_ELC_ELOPD_TMR2MD_Pos)            // Position of TMR2MD field.

/* TMR3 Operation Select Configuration (ELOPD register) */
#define BSP_FEATURE_ELC_TMR3_ELOP_REG                                      (R_ELC->ELOPD)                      // Register containing TMR3MD.
#define BSP_FEATURE_ELC_TMR3_ELOP_MASK                                     (R_ELC_ELOPD_TMR3MD_Msk)            // Mask for TMR3MD field.
#define BSP_FEATURE_ELC_TMR3_ELOP_POS                                      (R_ELC_ELOPD_TMR3MD_Pos)            // Position of TMR3MD field.

#define BSP_FEATURE_ESC_IS_AVAILABLE                                       (1UL)
#define BSP_FEATURE_ESC_NUM_PORTS                                          (2UL)                               // Feature not available on this device.
...
#define BSP_FEATURE_ESWM_SUPPORT_L2_L3_FORWARDING                          (1UL)                               // Whether or not the Ethernet switch supports forwarding table feature.
#define BSP_FEATURE_ESWM_SUPPORT_CBS                                       (1UL)                               // Whether or not the Ethernet switch supports CBS features.
#define BSP_FEATURE_ESWM_SUPPORT_TAS                                       (1UL)                               // Whether or not the Ethernet switch supports TAS features.
...
#define BSP_FEATURE_ESWM_SUPPORT_FRAME_PREEMPTION                          (1UL)                               // Whether or not the Ethernet switch supports frame preemption features.
...
#define BSP_FEATURE_EXDMAC_IS_AVAILABLE                                    (1UL)
#define BSP_FEATURE_EXDMAC_HAS_EDMCTL                                      (1UL)                               // EDMCTL register is available in the EXDMA peripheral block.
#define BSP_FEATURE_EXDMAC_HAS_REPEAT_BLOCK_MODE                           (1UL)                               // EDMTMD register's MD bit-field allows repeat-block transfers (value: 0b11)
#define BSP_FEATURE_EXDMAC_MAX_CHANNEL                                     (2UL)                               // Number of EXDMAC channels available.

#define BSP_FEATURE_FLASH_ARC_NSEC_MULTIPLE_MAX_COUNT                      (256UL)                             // Number of bits per counter when ARC_NSEC is configured as multiple counters.
#define BSP_FEATURE_FLASH_ARC_NSEC_NUM_COUNTERS                            (4UL)                               // Number of non-secure application anti-rollback counters that can be configured.
#define BSP_FEATURE_FLASH_ARC_NSEC_SINGLE_MAX_COUNT                        (1024UL)                            // Number of counter bits available when using the ARC_NSEC counter as a single, large counter.
#define BSP_FEATURE_FLASH_ARC_OEMBL_MAX_COUNT                              (64UL)                              // Number of counter bits for the ARC_OEMBL counter.
#define BSP_FEATURE_FLASH_ARC_SEC_MAX_COUNT                                (1024UL)                            // Number of counter bits for the ARC_SEC counter.
#define BSP_FEATURE_FLASH_CODE_FLASH_START                                 (0xFFF00000UL)                      // Start address of the Code Flash region.
#define BSP_FEATURE_FLASH_DATA_FLASH_START                                 (0x86900000UL)                      // Start address of the Data Flash region.
...
#define BSP_FEATURE_FLASH_HP_CF_REGION0_BLOCK_SIZE                         (0x00UL)                            // Block size of region 0.
#define BSP_FEATURE_FLASH_HP_CF_REGION0_SIZE                               (0x0UL)                             // Size of region 0.
#define BSP_FEATURE_FLASH_HP_CF_REGION1_BLOCK_SIZE                         (0x00UL)                            // Block size of region 1.
#define BSP_FEATURE_FLASH_HP_CF_WRITE_SIZE                                 (0UL)                               // Write size for code flash.
#define BSP_FEATURE_FLASH_HP_DF_BLOCK_SIZE                                 (0UL)                               // Block size of data flash.
#define BSP_FEATURE_FLASH_HP_DF_WRITE_SIZE                                 (0UL)                               // Write size for data flash.
#define BSP_FEATURE_FLASH_HP_HAS_BANKSEL                                   (0UL)                               // BANKSEL, BANKSEL_SEC and BANKSEL_SEL registers are present.
#define BSP_FEATURE_FLASH_HP_HAS_FMEPROT                                   (0UL)                               // FMEPROT register is present.
#define BSP_FEATURE_FLASH_HP_SUPPORTS_DUAL_BANK                            (0UL)                               // Device contains two code banks.
#define BSP_FEATURE_FLASH_HP_VERSION                                       (00UL)                              // Version of the FLASH_HP (FACI) peripheral/hardware.
...
#define BSP_FEATURE_FLASH_LP_FLASH_CLOCK_SRC                               (0UL)                               // Feature not available on this device.
...
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                                 (0xFFFFUL)                          // Mask of 32-bit GPT channel indices.
#define BSP_FEATURE_GPT_AD_DIRECT_START_CHANNEL_MASK                       (0xFFFFUL)                          // Mask of GPT channels supporting A/D conversion start.
...
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK                           (0xFFFFUL)                          // Mask of channels that support event count input (has GTUPSR register).
#define BSP_FEATURE_GPT_EVENT_COUNT_SUPPORTED                              (1UL)                               // At least one channel supports event counts.
#define BSP_FEATURE_GPT_GPTE_CHANNEL_MASK                                  (0xFFF0UL)                          // Mask of GPT channels that are the GPTE implementation.
...
#define BSP_FEATURE_GPT_GPTEH_SUPPORTED                                    (1UL)                               // At least one GPTEH implementation is available.
#define BSP_FEATURE_GPT_GTDVU_CHANNEL_MASK                                 (0xFFFFUL)                          // Mask of channels that support dead time control.
#define BSP_FEATURE_GPT_GTDVU_SUPPORTED                                    (1UL)                               // At least one GPT channel with   support is available.
#define BSP_FEATURE_GPT_GTDREQ_SUPPORTED                                   (0UL)                               // GTDREQ register is not available on this device.
#define BSP_FEATURE_GPT_HRPWM_128_RESOLUTION_CHANNEL_MASK                  (0x0FUL)                            // Mask of PWM channels which support 128-bit delay resolution.
#define BSP_FEATURE_GPT_HRPWM_128_RESOLUTION_SUPPORTED                     (1UL)                               // The PWM delay circuit supports 128-bit resolution for delays.
#define BSP_FEATURE_GPT_HRPWM_COMMON_WRITE_PROTECT_REQUIRED                (0UL)                               // HRPWM delay writes require only the associated channel write protection to be disabled.
#define BSP_FEATURE_GPT_HRPWM_FRANGE_FREQ_MIN                              (160000000UL)                       // Minimum frequency for standard HRPWM operation, must set HROCR1.FRANGE bit below this value.
#define BSP_FEATURE_GPT_HRPWM_FRANGE_SET_BIT(gpt_frequency)    ((BSP_FEATURE_GPT_HRPWM_FRANGE_FREQ_MIN <= \
                                                                 (gpt_frequency)) ? 1UL : 0UL)                 // Obtains the set bit based on the GPT frequency and the FRANGE threshold.
#define BSP_FEATURE_GPT_HRPWM_FREQ_MAX                                     (200000000UL)                       // Maximum supported frequency of the High Resolution PWM Generation circuit.
#define BSP_FEATURE_GPT_HRPWM_FREQ_MIN                                     (80000000UL)                        // Minimum supported frequency of the High Resolution PWM Generation circuit.
#define BSP_FEATURE_GPT_OPS_CHANNEL_MASK                                   (0xFFFFUL)                          // Mask of channels supporting output phase switching.
...
#define BSP_FEATURE_I3C_HAS_HOT_JOIN                                       (0UL)                               // Feature not available on this device.
...
#define BSP_FEATURE_I3C_NTDTBP0_DEPTH                                      (0UL)                               // Depth of the normal transmit data buffer.
#define BSP_FEATURE_I3C_NUM_CHANNELS                                       (1UL)                               // Total number of available channels.
#define BSP_FEATURE_I3C_VALID_CHANNEL_MASK                                 (1UL)                               // Mask of available I3C channels.
...
#define BSP_FEATURE_ICU_HAS_FILTER_MODE                                    (1UL)                               // IRQCR register has FLTMD bit for filter mode selection.
...
#define BSP_FEATURE_ICU_NMIER_MAX_INDEX                                    (18UL)                              // Maximum bit field index of valid fields of the NMIER register.
...
#define BSP_FEATURE_ICU_HAS_IER                                            (0xFFFFF73FFFFFUL)                  // IERm register is available.
...
#define BSP_FEATURE_IIC_B_FAST_MODE_PLUS                                   (0x07UL)                            // Mask of channels which support "Fast Mode Plus": up to 1 Mbps bit rates.
#define BSP_FEATURE_IIC_B_VALID_CHANNEL_MASK                               (0x07UL)                            // Mask of available IIC_B or compatible I3C channels.
...
#define BSP_FEATURE_IOPORT_ELC_PORTS_MASK                                  (0x7800UL)                          // Mask of valid indices for ELC signal mapping of port input data.
#define BSP_FEATURE_IOPORT_VERSION                                         (2UL)                               // Version of the system PFS block.
#define BSP_FEATURE_IOPORT_VBATT_PIN_INPUT_CH0                             (BSP_IO_PORT_03_PIN_10)             // Pin associated with VBTICTLR->VCH0INEN
#define BSP_FEATURE_IOPORT_VBATT_PIN_INPUT_CH1                             (BSP_IO_PORT_03_PIN_11)             // Pin associated with VBTICTLR->VCH1INEN
#define BSP_FEATURE_IOPORT_VBATT_PIN_INPUT_CH2                             (BSP_IO_PORT_03_PIN_12)             // Pin associated with VBTICTLR->VCH2INEN
...
#define BSP_FEATURE_IWDT_TIMEOUT_MULTIPLIER_SHIFT                          (0UL)
...
#define BSP_FEATURE_LPM_DPSIER_MASK                                        (0x0000FFFFF31FFFFFULL)             // Mask of valid bit-fields of the DPSIERn registers.
...
#define BSP_FEATURE_LPM_HAS_DCCR                                           (1UL)                               // The DCCR register is available.
#define BSP_FEATURE_LPM_HAS_SYOCDCR_DOCDF                                  (0UL)                               // The SYOCDCR.DOCDF field is available.
...
#define BSP_FEATURE_PVD_IS_AVAILABLE                                       (1UL)
#define BSP_FEATURE_PVD_HAS_DIGITAL_FILTER                                 (1UL)                               // Digital input filtering is available.
#define BSP_FEATURE_PVD_SUPPORT_RESET_ON_RISING_EDGE                       (1UL)                               // Voltage monitors support rising edge detections (i.e.
#define BSP_FEATURE_PVD_MONITOR_1_HI_THRESHOLD                             ( \
        VOLTAGE_DETECTION_THRESHOLD_MONITOR_LEVEL_3_86V)                                                       // Typical higher bound of the detection threshold for PVD1.
#define BSP_FEATURE_PVD_MONITOR_1_LOW_THRESHOLD                            ( \
        VOLTAGE_DETECTION_THRESHOLD_MONITOR_LEVEL_1_71V)                                                       // Typical lower bound of the detection threshold for PVD1.
#define BSP_FEATURE_PVD_MONITOR_1_STABILIZATION_TIME_US                    (30UL)                              // Maximum stabilization time to wait after PVD1 is enabled.
#define BSP_FEATURE_PVD_MONITOR_2_HI_THRESHOLD                             ( \
        VOLTAGE_DETECTION_THRESHOLD_MONITOR_LEVEL_3_86V)                                                       // Typical higher bound of the detection threshold for PVD2.
#define BSP_FEATURE_PVD_MONITOR_2_LOW_THRESHOLD                            ( \
        VOLTAGE_DETECTION_THRESHOLD_MONITOR_LEVEL_1_71V)                                                       // Typical lower bound of the detection threshold for PVD2.
#define BSP_FEATURE_PVD_MONITOR_2_STABILIZATION_TIME_US                    (30UL)                              // Maximum stabilization time to wait after PVD2 is enabled.
#define BSP_FEATURE_PVD_MONITOR_MASK                                       (0x1BUL)                            // Mask of programmable monitors.
#define BSP_FEATURE_PVD_SUPPORT_RESET_ON_RISING_EDGE                       (1UL)                               // Voltage monitors support rising edge detections (i.e.
...
#define BSP_FEATURE_DATA_MRAM_PROGRAMMING_SIZE_BYTES                       (16UL)                 // Write size for data MRAM.
...
#define BSP_FEATURE_XSPI_CONTROLLER_IS_AVAILABLE                           (1UL)
#define BSP_FEATURE_XSPI_CONTROLLER_UNIT_0_DEVICE_0_START_ADDRESS          (0x30000000UL)         // Start address of the CS0 of Unit 0 memory mapped region for XSPI_CONTROLLER.
#define BSP_FEATURE_XSPI_CONTROLLER_UNIT_0_DEVICE_1_START_ADDRESS          (0x20000000UL)         // Start address of the CS1 of Unit 0 memory mapped region for XSPI_CONTROLLER.
#define BSP_FEATURE_XSPI_CONTROLLER_UNIT_1_DEVICE_0_START_ADDRESS          (0x50000000UL)         // Start address of the CS0 of Unit 1 memory mapped region for XSPI_CONTROLLER.
#define BSP_FEATURE_XSPI_CONTROLLER_UNIT_1_DEVICE_1_START_ADDRESS          (0x40000000UL)         // Start address of the CS1 of Unit 1 memory mapped region for XSPI_CONTROLLER.
#define BSP_FEATURE_XSPI_CONTROLLER_UNIT_COUNT                             (2UL)                  // Number of XSPI_CONTROLLER peripheral units available.
#define BSP_FEATURE_XSPI_CONTROLLER_UNIT_0_DEVICE_0_SIZE                   (0x10000000UL)         // Size of the CS0 of Unit 0 memory mapped region for XSPI_CONTROLLER.
#define BSP_FEATURE_XSPI_CONTROLLER_UNIT_0_DEVICE_1_SIZE                   (0x10000000UL)         // Size of the CS1 of Unit 0 memory mapped region for XSPI_CONTROLLER.
#define BSP_FEATURE_XSPI_CONTROLLER_UNIT_1_DEVICE_0_SIZE                   (0x10000000UL)         // Size of the CS0 of Unit 1 memory mapped region for XSPI_CONTROLLER.
#define BSP_FEATURE_XSPI_CONTROLLER_UNIT_1_DEVICE_1_SIZE                   (0x10000000UL)         // Size of the CS1 of Unit 1 memory mapped region for XSPI_CONTROLLER.

#define BSP_FEATURE_XSPI_TARGET_IS_AVAILABLE                               (1UL)
#define BSP_FEATURE_XSPI_TARGET_UNIT_COUNT                                 (2UL)                  // Number of XSPI_TARGET peripheral units available.

#define BSP_FEATURE_POEG_CHANNEL_MASK                                      (0x0FUL)               // Mask of valid channels for POEG.
#define BSP_FEATURE_POEG_HAS_POEGG_DERRST                                  (1UL)                  // Indicates POEGG.DERRSTn registers are available.
...
#define BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED                               (1UL)                  // The device supports cryptography using RSIP_E50D.
...
#define BSP_FEATURE_RTC_HAS_RCR3                                           (0UL)                  // Feature not available on this MCU
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS                             (0x00UL)               // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS                                           (0x1FFFUL)             // Mask of available SCI channels.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS                                       (0x1FFFUL)             // Mask of channels that can support LIN.
#define BSP_FEATURE_SCI_SPI_SCKSEL_VALUE                                   (0UL)                  // Mask indicating CCR4.SCKSEL is available.
#define BSP_FEATURE_SCI_B_SPI_HAS_RX_SAMPLING_DELAY                        (0UL)                  // RX sampling delay feature is not available on this MCU
#define BSP_FEATURE_SCI_UART_ABCSE_RESTRICTED_CHANNELS                     (0x00UL)               // List of channels that do not support ABCSE functionality.
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS                               (0x1FFFUL)             // Mask of channels which support CTS external pins.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS                                 (0x1FFFUL)             // Mask of channels which support the UART FIFO.
...
#define BSP_FEATURE_SCI_BASE_ADDRESS_OFFSET_EQUAL                          (1UL)                  // Feature not available on this MCU
...
#define BSP_FEATURE_SDRAM_START_ADDRESS                                    (0x70000000UL)         // Start address of the external address space for SDRAM memory.
#define BSP_FEATURE_SDRAM_SIZE                                             (0x08000000UL)         // Size of SDRAM.

#define BSP_FEATURE_RAM_START_ADDRESS                                      (0x82000000UL)         // Start address of the internal RAM memory.
#define BSP_FEATURE_RAM_START_SIZE                                         (0x00180000UL)         // Size of the internal RAM memory.
...
#define BSP_FEATURE_SPI_MAX_CHANNEL                                        (3UL)                  // Number of available SPI channels.
...
#define BSP_FEATURE_SYSC_HAS_TAMPICR1                                      (1UL)                  // System supports TAMP/RTCIC input control to the RTC.
...
#define BSP_FEATURE_TFU_IS_AVAILABLE                                       (1UL)                  // The TFU peripheral is available.
#define BSP_FEATURE_TFU_SUPPORTED                                          (1UL)
...
#define BSP_FEATURE_TZ_HAS_TRUSTZONE                                       (0UL)                  // The device supports Arm TrustZone.
#define BSP_FEATURE_TZ_NS_OFFSET                                           (0x00UL)               // Offset for the Non-secure address space of a peripheral.
#define BSP_FEATURE_TZ_VERSION                                             (0UL)                  // Version of the TrustZone implementation.
...
#define BSP_FEATURE_ULPT_MAX_CHANNEL_NUM                                   (0UL)                  // Number of channels available for ULPT (this is NOT the maximum value for channel).
#define BSP_FEATURE_ULPT_VALID_CHANNEL_MASK                                (0UL)                  // Mask of available channels for ULPT.
...
#define BSP_FEATURE_BSP_HAS_DSMIF_CLOCK                                    (1UL)                  // Flag indicating an DSMIF clock is present.
#define BSP_FEATURE_BSP_HAS_ESW_CLOCK                                      (1UL)                  // Flag indicating an ESW clock is present.
#define BSP_FEATURE_BSP_HAS_ESWM_DOMAIN                                    (1UL)                  // Indicates that the MCU has a power domain specifically for ESWM peripherals.
#define BSP_FEATURE_BSP_HAS_ESWPHY_CLOCK                                   (1UL)                  // Flag indicating an ESWPHY clock is present.
#define BSP_FEATURE_BSP_HAS_ETHPHY_CLOCK                                   (1UL)                  // Flag indicating an ETHPHY clock is present.
#define BSP_FEATURE_BSP_HAS_ESC_CLOCK                                      (1UL)                  // Flag indicating an ESC clock is present.
#define BSP_FEATURE_BSP_HAS_GPT_CLOCK                                      (1UL)                  // The MCU supports GPT CLOCK
#define BSP_FEATURE_BSP_HAS_ENC0_CLOCK                                     (0UL)                  // The MCU supports ENC0 CLOCK
#define BSP_FEATURE_BSP_HAS_ENC1_CLOCK                                     (0UL)                  // The MCU supports ENC1 CLOCK
#define BSP_FEATURE_BSP_HAS_ED30_CLOCK                                     (0UL)                  // The MCU supports ED30 CLOCK
#define BSP_FEATURE_BSP_HAS_ED31_CLOCK                                     (0UL)                  // The MCU supports ED31 CLOCK
#define BSP_FEATURE_BSP_HAS_LRAM                                           (1UL)                  // Indicates LRAM is available.
#define BSP_FEATURE_BSP_MSTP_TMR_MSTPF7_MAX_CH                             (1UL)                  // Largest channel number associated with TMR on the MSTPCRF.MSTPF7 field on this MCU.
#define BSP_FEATURE_BSP_MSTP_CMT_MSTPF15_MAX_CH                            (1UL)                  // Largest channel number associated with CMT on the MSTPCRF.MSTPF15 field on this MCU.
#define BSP_FEATURE_PRC_MAX_PROTECT_BITS                                   (5UL)                  // Number of available protect bits.

#define BSP_FEATURE_CGC_HAS_CLKOUT                                         (1UL)                  // The MCU supports CLKOUT
#define BSP_FEATURE_CGC_HAS_MOCO                                           (1UL)                  // The MCU supports MOCO
#define BSP_FEATURE_CGC_HAS_OPCCR                                          (0UL)                  // The MCU supports OPCCR
#define BSP_FEATURE_CGC_HAS_OPERATING_SPEED_MODE                           (1UL)                  // The MCU supports operating speed mode
#define BSP_FEATURE_CGC_HAS_SDCLK                                          (1UL)                  // The MCU supports SDCLK

#define BSP_FEATURE_CMT_VALID_CHANNEL_MASK                                 (0x0FUL)               // Mask of CMT channel indices.

#define BSP_FEATURE_CMTW_CLOCK                                             (FSP_PRIV_CLOCK_PCLKB) // Indicates the clock provided to the CMTW.
#define BSP_FEATURE_CMTW_VALID_CHANNEL_MASK                                (0x03UL)               // Mask of CMTW channel indices.

#define BSP_FEATURE_DAC_MAX_CHANNELS                                       (2UL)                  // Number of DAC channels available.

#define BSP_FEATURE_DTC_MIN_VECTOR_NUMBER                                  (26UL)                 // Indicates the minimum interrupt source number that can activate the DTC.

#define BSP_FEATURE_GROUP_IRQ_NUM_INTERRUPTS                               (11UL)                 // Number of Group Interrupt.
#define BSP_FEATURE_GROUP_IRQ_NUM_FACTORS                                  (32UL)                 // Number of group interrupt sources.
#define BSP_FEATURE_GRP_IRQ_NMI_MAX_ITEMS                                  (32UL)                 // Number of NMI interrupt sources.
#define BSP_FEATURE_GRP_IRQ_NMI_TOTAL_ITEMS                                (19UL)                 // Number of maximum valid NMISR register bit.

#define BSP_FEATURE_I3C_SUPPORT_IIC                                        (1UL)                  // IIC is available in I3C module.
#define BSP_FEATURE_I3C_ICDR_DEPTH                                         (4UL)                  // Size of ICDR.

#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPAL0                               (1UL)                  // Indicates there is a group interrupt AL0.
#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPAL1                               (1UL)                  // Indicates there is a group interrupt AL1.
#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPAL2                               (1UL)                  // Indicates there is a group interrupt AL2.
#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPAL3                               (1UL)                  // Indicates there is a group interrupt AL3.
#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPAL4                               (1UL)                  // Indicates there is a group interrupt AL4.
#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPAL5                               (1UL)                  // Indicates there is a group interrupt AL5.
#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPAL6                               (1UL)                  // Indicates there is a group interrupt AL6.
#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPBL0                               (1UL)                  // Indicates there is a group interrupt BL0.
#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPBL1                               (1UL)                  // Indicates there is a group interrupt BL1.
#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPIL0                               (1UL)                  // Indicates there is a group interrupt IL0.
#define BSP_FEATURE_ICU_HAS_GRP_IRQ_GROUPIL1                               (0UL)                  // Indicates there is a group interrupt IL1.
#define BSP_FEATURE_ICU_HAS_DMAC_GRP_IRQ                                   (1UL)                  // The MCU supports DMAC group interrupt.
#define BSP_FEATURE_ICU_VERSION                                            (2UL)                  // Version of the ICU peripheral.

#define BSP_FEATURE_IOPORT_IS_AVAILABLE                                    (1UL)

#define BSP_FEATURE_IOPORT_B_IS_AVAILABLE                                  (0UL)

#define BSP_FEATURE_LRAM_SIZE                                              (0x40000UL)    // LRAM total size.
#define BSP_FEATURE_LRAM0_SIZE                                             (0x20000UL)    // LRAM0 size.

#define BSP_FEATURE_MRAM_HAS_CODE_MRAM_REGION_A                            (1UL)          // The MCU support MRCA area in Code MRAM region.
#define BSP_FEATURE_MRAM_HAS_CODE_MRAM_REGION_B                            (1UL)          // The MCU support MRCB area in Code MRAM region.
#define BSP_FEATURE_MRAM_PART_NUMBER_LENGTH                                (12UL)         // Length of the product part number.
#define BSP_FEATURE_MRAM_REGION_CODE_AREA_NUM                              (2UL)          // Number of MRAM regions.

#define BSP_FEATURE_SRAM_SIZE                                              (0x00180000UL) // SRAM total size.

#define BSP_FEATURE_PSW_MAX_IPL                                            (31UL)         // Number of processor interrupt priority level available.
#define BSP_FEATURE_PSW_IPL_MASK                                           (0x1F)         // Mask of value for PSW IPL bits.

#define BSP_FEATURE_PZ_HAS_PROTECTZONE                                     (1UL)          // The device supports RX ProtectZone.
#define BSP_FEATURE_PZ_S_OFFSET                                            (0x80000000UL) // Offset for the Secure address space of a peripheral.

#define BSP_FEATURE_PZ_ELCSARA_MASK                                        (0x000F001EUL) // Mask of value for ELCSARA Register.
#define BSP_FEATURE_PZ_ELCSARB_MASK                                        (0x07FFFFFFUL) // Mask of value for ELCSARB Register.
#define BSP_FEATURE_PZ_ELCSARC_MASK                                        (0xFFFCC000UL) // Mask of value for ELCSARC Register.
#define BSP_FEATURE_PZ_ELCSARD_MASK                                        (0x0F007FFFUL) // Mask of value for ELCSARD Register.

#define BSP_FEATURE_SCI_HAS_SISSR                                          (1UL)          // SISSR register is available.
#define BSP_FEATURE_SCI_MAX_CHANNEL                                        (13UL)         // Number of SCI channels available.

#define BSP_FEATURE_SDHI_CRC_CHECK                                         (1UL)          // Supports CRC check.

#define BSP_FEATURE_SPI_HAS_SPPSR                                          (1UL)          // SPPSR register is available.

#define BSP_FEATURE_XSPI_CONTROLLER_HAS_CHANNEL_1                          (0UL)          // Indicates XSPI_CONTROLLER support channel 1 in each unit.

#define BSP_FEATURE_TMR_VALID_CHANNEL_MASK                                 (0x0FUL)
#define BSP_FEATURE_TMR_VALID_CHANNEL_16_BIT_MASK                          (0x05UL)
#define BSP_FEATURE_TMR_MAX_CASCADED_CHANNEL                               (0x02UL)
#define BSP_FEATURE_TMR_CHANNELS                                           (0x03UL)
#define BSP_FEATURE_TMR_ADC_TRIGGER                                        (0x00UL) // Feature not available on this device.

#define BSP_INTERRUPT_SLIXR_ENTRY_NUM                                      (128UL)
#define BSP_INTERRUPT_SLIR_ENTRY_NUM                                       (144UL)

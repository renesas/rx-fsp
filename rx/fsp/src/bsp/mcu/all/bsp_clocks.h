...
/* The following definitions are macros instead of enums because the values are used in preprocessor conditionals. */
/* Must match BCLKCR.EBCKASEL values. */
#define BSP_CLOCKS_SOURCE_CLOCK_BCLK               (0)
#define BSP_CLOCKS_SOURCE_CLOCK_BCLKA              (1)
...
/* The following definitions are macros instead of enums because the values are used in preprocessor conditionals. */
/* Must match CKOCR.CKOSEL values. */
#define BSP_CLOCKS_CLKOUT_SOURCE_CLOCK_HOCO        (0)  // The high speed on chip oscillator.
#define BSP_CLOCKS_CLKOUT_SOURCE_CLOCK_MOCO        (1)  // The middle speed on chip oscillator.
#define BSP_CLOCKS_CLKOUT_SOURCE_CLOCK_LOCO        (2)  // The low speed on chip oscillator.
#define BSP_CLOCKS_CLKOUT_SOURCE_CLOCK_MAIN_OSC    (3)  // The main oscillator.
#define BSP_CLOCKS_CLKOUT_SOURCE_CLOCK_SUBCLOCK    (4)  // The subclock oscillator.
#define BSP_CLOCKS_CLKOUT_SOURCE_CLOCK_ICLK        (5)  // The ICLK.

#if (1 < BSP_FEATURE_CGC_PLL1_NUM_OUTPUT_CLOCKS && 1 < BSP_FEATURE_CGC_PLL2_NUM_OUTPUT_CLOCKS)
 #define BSP_CLOCKS_CLKOUT_SOURCE_CLOCK_PLL1P      (8)  // The PLL1P oscillator.
 #define BSP_CLOCKS_CLKOUT_SOURCE_CLOCK_PLL2P      (13) // The PLL2P oscillator.
 #define BSP_CLOCKS_CLKOUT_SOURCE_CLOCK_PLL1Q      (14) // The PLL1Q oscillator.
 #define BSP_CLOCKS_CLKOUT_SOURCE_CLOCK_PLL2Q      (15) // The PLL2Q oscillator.
...
#define BSP_PRV_MRPCLK_DIV_VALUE             BSP_PRV_SCKDIVCR_DIV_VALUE(BSP_CFG_FCLK_DIV)
...
#define BSP_STARTUP_MRPCLK_HZ                (BSP_STARTUP_SOURCE_CLOCK_HZ / BSP_PRV_MRPCLK_DIV_VALUE)
...
#define BSP_CLOCKS_USB_CLOCK_DIV_10          (7)  // Divide USB source clock by 10
#define BSP_CLOCKS_USB_CLOCK_DIV_16          (8)  // Divide USB source clock by 16
...
#define BSP_CLOCKS_USB60_CLOCK_DIV_6         (3)  // Divide USB60 source clock by 6
...
/* ESC clock divider options. */
#define BSP_CLOCKS_ESC_CLOCK_DIV_1           (0)  // Divide ESC source clock by 1
#define BSP_CLOCKS_ESC_CLOCK_DIV_2           (1)  // Divide ESC source clock by 2
#define BSP_CLOCKS_ESC_CLOCK_DIV_3           (5)  // Divide ESC source clock by 3
#define BSP_CLOCKS_ESC_CLOCK_DIV_4           (2)  // Divide ESC source clock by 4
#define BSP_CLOCKS_ESC_CLOCK_DIV_5           (6)  // Divide ESC source clock by 5
#define BSP_CLOCKS_ESC_CLOCK_DIV_6           (3)  // Divide ESC source clock by 6
#define BSP_CLOCKS_ESC_CLOCK_DIV_8           (4)  // Divide ESC source clock by 8
#define BSP_CLOCKS_ESC_CLOCK_DIV_10          (7)  // Divide ESC source clock by 10
#define BSP_CLOCKS_ESC_CLOCK_DIV_16          (8)  // Divide ESC source clock by 16
#define BSP_CLOCKS_ESC_CLOCK_DIV_32          (9)  // Divide ESC source clock by 32
...
/* DSMIF clock divider options. */
#define BSP_CLOCKS_DSMIF_CLOCK_DIV_1         (0)  // Divide DSMIF source clock by 1
#define BSP_CLOCKS_DSMIF_CLOCK_DIV_2         (1)  // Divide DSMIF source clock by 2
#define BSP_CLOCKS_DSMIF_CLOCK_DIV_3         (5)  // Divide DSMIF source clock by 3
#define BSP_CLOCKS_DSMIF_CLOCK_DIV_4         (2)  // Divide DSMIF source clock by 4
#define BSP_CLOCKS_DSMIF_CLOCK_DIV_5         (6)  // Divide DSMIF source clock by 5
#define BSP_CLOCKS_DSMIF_CLOCK_DIV_6         (3)  // Divide DSMIF source clock by 6
#define BSP_CLOCKS_DSMIF_CLOCK_DIV_8         (4)  // Divide DSMIF source clock by 8
#define BSP_CLOCKS_DSMIF_CLOCK_DIV_10        (7)  // Divide DSMIF source clock by 10
#define BSP_CLOCKS_DSMIF_CLOCK_DIV_16        (8)  // Divide DSMIF source clock by 16
#define BSP_CLOCKS_DSMIF_CLOCK_DIV_32        (9)  // Divide DSMIF source clock by 32
...
#define BSP_PRV_SCKDIVCR_MRPCLK_MASK           (FSP_PRV_SCKDIVCR_DIV_MASK << 28)
#define BSP_PRV_SCKDIVCR_MASK                  (BSP_PRV_SCKDIVCR_ICLK_MASK | BSP_PRV_SCKDIVCR_PCLKD_MASK |  \
                                                ...
                                                BSP_PRV_SCKDIVCR_PCLKE_MASK | BSP_PRV_SCKDIVCR_MRPCLK_MASK)
...
/* FLL is only used when enabled, present and the subclock is populated. */
 ...
 #define BSP_PRV_RTC_RESET_DELAY_US            (202)
#endif

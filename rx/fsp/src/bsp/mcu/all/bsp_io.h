...
#ifndef BSP_OVERRIDE_BSP_IO_PORT_T
...
#ifndef BSP_OVERRIDE_BSP_IO_PORT_PIN_T
...
typedef enum e_bsp_io_port_pin_t
{
    ...
    BSP_IO_PORT_15_PIN_04 = 0x0F04,    ///< IO port 15 pin 4
    BSP_IO_PORT_15_PIN_05 = 0x0F05,    ///< IO port 15 pin 5
    BSP_IO_PORT_15_PIN_06 = 0x0F06,    ///< IO port 15 pin 6
    BSP_IO_PORT_15_PIN_07 = 0x0F07,    ///< IO port 15 pin 7
    BSP_IO_PORT_15_PIN_08 = 0x0F08,    ///< IO port 15 pin 8
    BSP_IO_PORT_15_PIN_09 = 0x0F09,    ///< IO port 15 pin 9
    BSP_IO_PORT_15_PIN_10 = 0x0F0A,    ///< IO port 15 pin 10
    BSP_IO_PORT_15_PIN_11 = 0x0F0B,    ///< IO port 15 pin 11
    BSP_IO_PORT_15_PIN_12 = 0x0F0C,    ///< IO port 15 pin 12
    BSP_IO_PORT_15_PIN_13 = 0x0F0D,    ///< IO port 15 pin 13
    BSP_IO_PORT_15_PIN_14 = 0x0F0E,    ///< IO port 15 pin 14
    BSP_IO_PORT_15_PIN_15 = 0x0F0F,    ///< IO port 15 pin 15

    BSP_IO_PORT_16_PIN_00 = 0x1000,    ///< IO port 16 pin 0
    BSP_IO_PORT_16_PIN_01 = 0x1001,    ///< IO port 16 pin 1
    BSP_IO_PORT_16_PIN_02 = 0x1002,    ///< IO port 16 pin 2
    BSP_IO_PORT_16_PIN_03 = 0x1003,    ///< IO port 16 pin 3
    BSP_IO_PORT_16_PIN_04 = 0x1004,    ///< IO port 16 pin 4
    BSP_IO_PORT_16_PIN_05 = 0x1005,    ///< IO port 16 pin 5
    BSP_IO_PORT_16_PIN_06 = 0x1006,    ///< IO port 16 pin 6
    BSP_IO_PORT_16_PIN_07 = 0x1007,    ///< IO port 16 pin 7
    BSP_IO_PORT_16_PIN_08 = 0x1008,    ///< IO port 16 pin 8
    BSP_IO_PORT_16_PIN_09 = 0x1009,    ///< IO port 16 pin 9
    BSP_IO_PORT_16_PIN_10 = 0x100A,    ///< IO port 16 pin 10
    BSP_IO_PORT_16_PIN_11 = 0x100B,    ///< IO port 16 pin 11
    BSP_IO_PORT_16_PIN_12 = 0x100C,    ///< IO port 16 pin 12
    BSP_IO_PORT_16_PIN_13 = 0x100D,    ///< IO port 16 pin 13
    BSP_IO_PORT_16_PIN_14 = 0x100E,    ///< IO port 16 pin 14
    BSP_IO_PORT_16_PIN_15 = 0x100F,    ///< IO port 16 pin 15
...
__STATIC_INLINE void R_BSP_PinAccessEnable (void)
{
    ...
    if (0 == g_protect_pfswe_counter)
    {
        ...
        R_PMISC->PWPR_S = 0;                               ///< Clear BOWI bit - writing to PFSWE bit enabled
        R_PMISC->PWPR_S = 1U << BSP_IO_PWPR_PFSWE_OFFSET;  ///< Set PFSWE bit - writing to PFS register enabled
 #else
        R_PMISC->PWPR_NS = 0;                              ///< Clear BOWI bit - writing to PFSWE bit enabled
        R_PMISC->PWPR_NS = 1U << BSP_IO_PWPR_PFSWE_OFFSET; ///< Set PFSWE bit - writing to PFS register enabled
 #endif
    }
...
__STATIC_INLINE void R_BSP_PinAccessDisable (void)
{
    ...
    {
 #if !BSP_PZ_NONSECURE_BUILD
        R_PMISC->PWPR_S = 0;                              ///< Clear PFSWE bit - writing to PFSWE bit enabled
        R_PMISC->PWPR_S = 1U << BSP_IO_PWPR_B0WI_OFFSET;  ///< Set BOWI bit - writing to PFS register enabled
 #else
        R_PMISC->PWPR_NS = 0;                             ///< Clear PFSWE bit - writing to PFSWE bit enabled
        R_PMISC->PWPR_NS = 1U << BSP_IO_PWPR_B0WI_OFFSET; ///< Set BOWI bit - writing to PFS register enabled
 #endif
    }

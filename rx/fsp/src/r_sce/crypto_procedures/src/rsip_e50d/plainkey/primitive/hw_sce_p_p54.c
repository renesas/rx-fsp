                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0x2aca0e4fU, 0x1dbfccdfU, 0x240ea2f3U, 0xa58da961U);
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        HW_SCE_p_func101(0xedf2e3adU, 0xff33aaf0U, 0x1e86c917U, 0xf9c26d79U);
        HW_SCE_p_func043();
        ...
        HW_SCE_p_func101(0x12164304U, 0x9ed50d7fU, 0x03b02971U, 0x97676952U);
        HW_SCE_p_func044();
        ...
        for (iLoop = 32; iLoop < 64U; iLoop = iLoop + 8U)
        {
            WAIT_STS(REG_1444H, 31, 1);
            WR4_ADDR(REG_1420H, &InData_KeyIndex[iLoop + 1]);
            WAIT_STS(REG_1444H, 31, 1);
        ...
        HW_SCE_p_func101(0x5419d8adU, 0xe181bfd9U, 0xec650e3cU, 0x18c08630U);
    }
    else
    {
        WR1_PROG(REG_1444H, 0x00003fc2U);
        ...
        HW_SCE_p_func101(0x02eaa1b5U, 0x7d18ebd1U, 0x4c1fdec1U, 0x31800aa1U);
    }

    HW_SCE_p_func100(0xfa528f05U, 0xd93048c3U, 0x4ad01491U, 0x2e195595U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0xa57db538U, 0x2fd20960U, 0xe5751d09U, 0x7d04856fU);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x4875502eU, 0xfae0d0a2U, 0xdd12cdbfU, 0x5da05a6eU);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x8e1334bdU, 0xc410127bU, 0xf784bbbaU, 0x65ab5620U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func100(0x83830a16U, 0x64eb37f3U, 0xe84caf9eU, 0xffcce942U);
            ...
            HW_SCE_p_func100(0x53bb403dU, 0x74197267U, 0xffa05bb1U, 0xd77457faU);
            ...
            HW_SCE_p_func100(0x8fc01bc8U, 0x43c6857cU, 0x513e4275U, 0x9640eb04U);
            WR1_PROG(REG_1A2CH, 0x00000200U);
            WR1_PROG(REG_1A24H, 0x08008107U);
            WR1_PROG(REG_1400H, 0x00830031U);
            WAIT_STS(REG_1404H, 30, 0);
            ...
            HW_SCE_p_func100(0x7143495fU, 0x05f1763aU, 0xa765c10aU, 0xd1eb151fU);
            ...
            HW_SCE_p_func102(0x2a661cd2U, 0xb6455d35U, 0xae520c40U, 0xddfc7858U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);

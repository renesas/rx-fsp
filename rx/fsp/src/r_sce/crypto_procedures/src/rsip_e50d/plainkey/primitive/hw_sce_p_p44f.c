                                     ...
                                     uint32_t       OutData_DataT[])
{
    ...
    if ((InData_Cmd[0] == 0x00000000U) || (InData_Cmd[0] == 0x00000002U))
    {
        ...
        HW_SCE_p_func101(0x6af0deb7U, 0x0444af79U, 0x3eaf9023U, 0x1836e82cU);
    }
    else
    {
        WR1_PROG(REG_1444H, 0x000000a1U);
        ...
        HW_SCE_p_func101(0x49b170f7U, 0x1af473dfU, 0x5fb6903dU, 0xd73b71a1U);
    }
    ...
    {
        HW_SCE_p_func100(0xb300bbc1U, 0x34c0ed81U, 0xe185c36cU, 0xffcb8a5eU);
        ...
        HW_SCE_p_func102(0x13bec97eU, 0x50dc8d9dU, 0x43de361bU, 0x43952553U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x280a964fU, 0x7b61d69eU, 0xb01b9b6bU, 0xbea0e2f4U);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x2a1aaabaU, 0x641567e2U, 0x0b3dcfffU, 0x07b232abU);
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        else
        {
            ...
            HW_SCE_p_func100(0x82e5e6e5U, 0x2cf2dfeeU, 0x94868f0cU, 0xb0214699U);
            WR1_PROG(REG_143CH, 0x00400000U);

            if (CHCK_STS(REG_143CH, 22, 1))
            {
                HW_SCE_p_func102(0x707de8f0U, 0x3f2ad264U, 0xc633209bU, 0xdeffe989U);
                WR1_PROG(REG_14BCH, 0x00000040U);
                WAIT_STS(REG_142CH, 12, 0);
            ...
            {
                HW_SCE_p_func102(0x269810c0U, 0x4faac2edU, 0x26c3db23U, 0xcdab74daU);
                WR1_PROG(REG_14BCH, 0x00000040U);
                WAIT_STS(REG_142CH, 12, 0);

                                           ...
                                           uint32_t       OutData_DataT[])
{
    ...
    HW_SCE_p_func100(0xfd3efbacU, 0xb545ddcfU, 0x97bee156U, 0x93cdea46U);
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        HW_SCE_p_func101(0xa72f0d17U, 0x39f53226U, 0x5e972374U, 0xb4e6dcb9U);
    }
    else
    {
        WR1_PROG(REG_1600H, 0x0000b580U);
        ...
        HW_SCE_p_func101(0xf4c48aa4U, 0x82b8fd8cU, 0x82293c9aU, 0x45c8ec44U);
    }

    HW_SCE_p_func100(0x446d936cU, 0x37f877e8U, 0x26041ea6U, 0xb91228baU);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x16f11d53U, 0x4013a7b8U, 0x98efa5beU, 0x25e2a099U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x383a7a8dU, 0xf51ee44dU, 0x0329808aU, 0xe79b3cadU);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func100(0xa8f39ab1U, 0x5abd30c7U, 0xaa1703eaU, 0x55ccda7fU);
            ...
            HW_SCE_p_func101(0x5dc445a1U, 0x12dba3ceU, 0x2d794c9fU, 0x5a2fb0ebU);
        }

        HW_SCE_p_func100(0xbfbe5075U, 0x67527d05U, 0x8eb73e33U, 0x4f4121bcU);
        ...
        HW_SCE_p_func102(0x7593b90bU, 0xa22aa52dU, 0xb9d87981U, 0x82c7612eU);
        WR1_PROG(REG_14BCH, 0x00000040U);
        WAIT_STS(REG_142CH, 12, 0);

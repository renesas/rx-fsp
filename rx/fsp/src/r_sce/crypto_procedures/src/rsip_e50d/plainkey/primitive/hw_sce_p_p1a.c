                                                      ...
                                                      uint32_t       OutData_PrivKey[])
{
    ...
    HW_SCE_p_func100(0xab9f0187U, 0x3bdd9acaU, 0x8743358eU, 0xc7a262aeU);
    HW_SCE_p_func103();
    HW_SCE_p_func100(0x5693eb9dU, 0x90e3197cU, 0x897571dfU, 0x4f38dc94U);
    ...
    HW_SCE_p_func100(0x39a2d1ceU, 0x791e954fU, 0x5c97d793U, 0x9cf096abU);
    HW_SCE_p_func401(InData_DomainParam);

    HW_SCE_p_func100(0x40f8b0e0U, 0x707bb1b7U, 0x363076e5U, 0x988600f6U);
    ...
    for (iLoop = 0U; iLoop < 256U; iLoop++)
    {
        ...
        HW_SCE_p_func101(0x11c0cdc9U, 0xd9b59b20U, 0x1517a996U, 0x2aca29e5U);
        HW_SCE_p_func402();
        ...
        HW_SCE_p_func101(0x0e3d0f87U, 0xe427ace9U, 0x611a9054U, 0xf8b08ef6U);
    }
    ...
    HW_SCE_p_func100(0x2a29c25dU, 0xac4469abU, 0x07ef4c61U, 0x15b7ed28U);
    ...
    HW_SCE_p_func100(0x40dce323U, 0xebeaf93aU, 0x819298e1U, 0xd7855762U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func100(0xa0aab9f4U, 0x5d20be4dU, 0x71f4e1a0U, 0xacdde3b0U);
        HW_SCE_p_func103();
        ...
        HW_SCE_p_func101(0xc5652774U, 0xde506294U, 0x0bc09595U, 0xa8cc95c6U);
        HW_SCE_p_func043();
        ...
        HW_SCE_p_func101(0x21c2cd68U, 0xe77699aaU, 0x9e8b9feaU, 0x10e801b2U);
        HW_SCE_p_func044();

        HW_SCE_p_func100(0x21da61d5U, 0xf0f018c8U, 0x4f92903aU, 0xdb3e52c9U);
        ...
        HW_SCE_p_func100(0x77f609d6U, 0x1638bd47U, 0x45ce10a8U, 0x3d663667U);
        WR1_PROG(REG_1444H, 0x000000a2U);
        ...
        HW_SCE_p_func100(0x7d7feda2U, 0x661ebda2U, 0x21263a1eU, 0x200e2a2cU);
        WR1_PROG(REG_1608H, 0x81010000U);
        WR1_PROG(REG_1408H, 0x00005006U);
        WAIT_STS(REG_1408H, 30, 1);
        RD1_ADDR(REG_1420H, &OutData_PrivKeyIndex[0]);

        HW_SCE_p_func101(0x9925544fU, 0xa8c30932U, 0x9a2c3e4dU, 0xe232847aU);
    }
    else
    {
        HW_SCE_p_func100(0x41390fe3U, 0xe51c2ec4U, 0x5ea7bd79U, 0x25617642U);
        WR1_PROG(REG_1608H, 0x81880001U);
        ...
        HW_SCE_p_func101(0x8b9b6b58U, 0xb84a9e4aU, 0x682fa2e0U, 0xdd0009bcU);
    }

    HW_SCE_p_func100(0x54414b1dU, 0x2a2df139U, 0x39098527U, 0x5c2835c3U);
    WR1_PROG(REG_1600H, 0x00000821U);
    WR1_PROG(REG_1608H, 0x81880001U);
    WR1_PROG(REG_1408H, 0x00005022U);
    for (iLoop = 0U; iLoop < 8U; iLoop++)
    ...
    HW_SCE_p_func102(0xa3b4d81eU, 0xa177a350U, 0xde88e337U, 0xc8c224c6U);

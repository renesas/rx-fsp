...
fsp_err_t HW_SCE_Rsa4096ModularExponentDecryptSub (const uint32_t InData_KeyMode[],
                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0x9c28c119U, 0xc71c9d96U, 0xd619eb7fU, 0x55a1da9dU);
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        HW_SCE_p_func101(0x3fa914efU, 0x7cbc626fU, 0x940c9423U, 0xf5e47db0U);
        HW_SCE_p_func043();
        ...
        HW_SCE_p_func101(0x4228eb82U, 0x811d4f1cU, 0xc1ee0ff2U, 0x63764c2bU);
        HW_SCE_p_func044();
        ...
        for (iLoop = 128; iLoop < 256U; iLoop = iLoop + 8U)
        {
            WAIT_STS(REG_1444H, 31, 1);
            WR4_ADDR(REG_1420H, &InData_KeyIndex[iLoop + 1]);
            WAIT_STS(REG_1444H, 31, 1);
        ...
        HW_SCE_p_func101(0x657bfe12U, 0x98f81202U, 0xb05465ffU, 0x3acbd461U);
    }
    else
    {
        WR1_PROG(REG_1444H, 0x0000ffc2U);
        ...
        HW_SCE_p_func101(0x585b54b6U, 0x98cd77b5U, 0x1b0a9344U, 0xbbc6fd5dU);
    }

    HW_SCE_p_func100(0x62eefb23U, 0x94384684U, 0x68b75b17U, 0x7309e922U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0xba43a23bU, 0xb7ebb8c8U, 0x120799f0U, 0x8a010c85U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0xb76c439fU, 0x20210590U, 0x426f80fcU, 0xc66bf1abU);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x012401a5U, 0xa27c5d9bU, 0x3cef110aU, 0x788dae61U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func100(0x1518be80U, 0xe0db1ad2U, 0x9e144889U, 0xbfd8621eU);
            ...
            for (iLoop = 0U; iLoop < 128U; iLoop = iLoop + 8U)
            {
                ...
                HW_SCE_p_func100(0xd6628586U, 0x83468bdaU, 0x828324e5U, 0x32873215U);
                ...
                HW_SCE_p_func101(0x52f80464U, 0xc539efdeU, 0xf231dec5U, 0xd0524ff6U);
            }
            ...
            HW_SCE_p_func100(0x43e6c784U, 0x5f146023U, 0x475ed473U, 0x878cd9e7U);
            WR1_PROG(REG_1408H, 0x00020000U);

            HW_SCE_p_func102(0x95eaf14cU, 0x1dad8b3fU, 0xe71ee08bU, 0x5a315dd4U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);

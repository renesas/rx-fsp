                                           ...
                                           uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0xe7b8d19bU, 0xd73e44a5U, 0x49c8207cU, 0xa3dea9bcU);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x78fab551U, 0x0f0af6f6U, 0xb39992deU, 0xa443b7f9U);
    ...
    {
        HW_SCE_p_func100(0x74b8d686U, 0x362993d5U, 0x609f6a64U, 0x94a177c8U);
        ...
        HW_SCE_p_func100(0xf9ed17d7U, 0xd28af31aU, 0xd8acebdaU, 0xdf6cce34U);
        ...
        HW_SCE_p_func100(0x0c7cea36U, 0x0db783afU, 0x20b4079eU, 0x19fe032aU);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func100(0x5cf15f0aU, 0xb2e34a31U, 0xa19cc342U, 0x171097a8U);
            ...
            for (jLoop = 0U; jLoop < S_RAM[0]; jLoop++)
            {
                ...
                HW_SCE_p_func101(0xf9768af8U, 0x11e1ff06U, 0x2274845dU, 0xaf7b938cU);
            }

            WR1_PROG(REG_1458H, 0x00000000U);
            HW_SCE_p_func100(0xf0f056b0U, 0x3af97690U, 0x617591ccU, 0xa7b8b93eU);
            ...
            for (jLoop = 0U; jLoop < S_RAM[0]; jLoop++)
            {
                ...
                HW_SCE_p_func101(0x1d8bdbacU, 0x2015013aU, 0x1b5a79e4U, 0xf9c2d0ccU);
            }

            WR1_PROG(REG_1458H, 0x00000000U);
            HW_SCE_p_func100(0x9b7e7f70U, 0x953074fbU, 0xbe2ab869U, 0xfd405bdeU);
            ...
            HW_SCE_p_func101(0xd5de3203U, 0x4cefbb7dU, 0xae17bfe4U, 0x3ba65478U);
        }

        HW_SCE_p_func102(0x6c7e9a61U, 0x070e9aa2U, 0x9a132ae4U, 0x5ac5eed0U);
        WR1_PROG(REG_14BCH, 0x00000040U);
        WAIT_STS(REG_142CH, 12, 0);

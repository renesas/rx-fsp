...
/* For HMAC operation. */
 ...
 #define HW_SCE_RSA2048_RANDOM_PRIVATE_KEY_BYTE_SIZE             (128 * 4U)
 #define HW_SCE_RSA2048_RANDOM_PUBLIC_KEY_BYTE_SIZE              (68 * 4U)
...
#define SCE_OEM_KEY_SIZE_CHACHA20_POLY_1305_KEY_INST_DATA_WORD   (12)
...
typedef enum
{
 ...
 typedef enum e_sce_oem_cmd
 {
     ...
     SCE_OEM_CMD_CHACHA20_POLY_1305 = 48,
     SCE_OEM_CMD_NUM
 } sce_oem_cmd_t;
 ...
 *********************************************************************************************************************/
fsp_err_t HW_SCE_Open(lifecycle_t                                   lifecycle,
                      sce_tls_ca_certification_public_key_index_t * key_index_1,
...
fsp_err_t HW_SCE_UpdateOemKeyIndex(lifecycle_t   lifecycle,
...
fsp_err_t HW_SCE_GenerateAes128KeyIndex(uint8_t             * encrypted_provisioning_key,
                                        uint8_t             * iv,
                                        uint8_t             * encrypted_key,
                                        sce_aes_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateAes192KeyIndex(uint8_t             * encrypted_provisioning_key,
                                        uint8_t             * iv,
                                        uint8_t             * encrypted_key,
                                        sce_aes_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateAes256KeyIndex(uint8_t             * encrypted_provisioning_key,
                                        uint8_t             * iv,
                                        uint8_t             * encrypted_key,
                                        sce_aes_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateTdesKeyIndex(uint8_t              * encrypted_provisioning_key,
                                      uint8_t              * iv,
                                      uint8_t              * encrypted_key,
                                      sce_tdes_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateRsa1024PublicKeyIndex(uint8_t                        * encrypted_provisioning_key,
                                               uint8_t                        * iv,
                                               uint8_t                        * encrypted_key,
                                               sce_rsa1024_public_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateRsa1024PrivateKeyIndex(uint8_t                         * encrypted_provisioning_key,
                                                uint8_t                         * iv,
                                                uint8_t                         * encrypted_key,
                                                sce_rsa1024_private_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateRsa2048PublicKeyIndex(uint8_t                        * encrypted_provisioning_key,
                                               uint8_t                        * iv,
                                               uint8_t                        * encrypted_key,
                                               sce_rsa2048_public_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateRsa2048PrivateKeyIndex(uint8_t                         * encrypted_provisioning_key,
                                                uint8_t                         * iv,
                                                uint8_t                         * encrypted_key,
                                                sce_rsa2048_private_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateRsa3072PublicKeyIndex(uint8_t                        * encrypted_provisioning_key,
                                               uint8_t                        * iv,
                                               uint8_t                        * encrypted_key,
                                               sce_rsa3072_public_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateRsa3072PrivateKeyIndex(uint8_t                         * encrypted_provisioning_key,
                                                uint8_t                         * iv,
                                                uint8_t                         * encrypted_key,
                                                sce_rsa3072_private_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateRsa4096PublicKeyIndex(uint8_t                        * encrypted_provisioning_key,
                                               uint8_t                        * iv,
                                               uint8_t                        * encrypted_key,
                                               sce_rsa4096_public_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateRsa4096PrivateKeyIndex(uint8_t                         * encrypted_provisioning_key,
                                                uint8_t                         * iv,
                                                uint8_t                         * encrypted_key,
                                                sce_rsa4096_private_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateTlsRsaPublicKeyIndex(uint8_t                                     * encrypted_provisioning_key,
                                              uint8_t                                     * iv,
                                              uint8_t                                     * encrypted_key,
                                              sce_tls_ca_certification_public_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateEccP192PublicKeyIndex(uint8_t                    * encrypted_provisioning_key,
                                               uint8_t                    * iv,
                                               uint8_t                    * encrypted_key,
                                               sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateEccP224PublicKeyIndex(uint8_t                    * encrypted_provisioning_key,
                                               uint8_t                    * iv,
                                               uint8_t                    * encrypted_key,
                                               sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateEccP256PublicKeyIndex(uint8_t                    * encrypted_provisioning_key,
                                               uint8_t                    * iv,
                                               uint8_t                    * encrypted_key,
                                               sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateEccP384PublicKeyIndex(uint8_t                    * encrypted_provisioning_key,
                                               uint8_t                    * iv,
                                               uint8_t                    * encrypted_key,
                                               sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateEccP192PrivateKeyIndex(uint8_t                     * encrypted_provisioning_key,
                                                uint8_t                     * iv,
                                                uint8_t                     * encrypted_key,
                                                sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateEccP224PrivateKeyIndex(uint8_t                     * encrypted_provisioning_key,
                                                uint8_t                     * iv,
                                                uint8_t                     * encrypted_key,
                                                sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateEccP256PrivateKeyIndex(uint8_t                     * encrypted_provisioning_key,
                                                uint8_t                     * iv,
                                                uint8_t                     * encrypted_key,
                                                sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateEccP384PrivateKeyIndex(uint8_t                     * encrypted_provisioning_key,
                                                uint8_t                     * iv,
                                                uint8_t                     * encrypted_key,
                                                sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateSha1HmacKeyIndex(uint8_t                  * encrypted_provisioning_key,
                                          uint8_t                  * iv,
                                          uint8_t                  * encrypted_key,
                                          sce_hmac_sha_key_index_t * key_index);
fsp_err_t HW_SCE_GenerateSha256HmacKeyIndex(uint8_t                  * encrypted_provisioning_key,
                                            uint8_t                  * iv,
                                            uint8_t                  * encrypted_key,
                                            sce_hmac_sha_key_index_t * key_index);
...
fsp_err_t HW_SCE_GenerateUpdateKeyRingKeyIndex(lifecycle_t             lifecycle,
                                               uint8_t               * encrypted_provisioning_key,
                                               uint8_t               * iv,
                                               uint8_t               * encrypted_key,
                                               sce_update_key_ring_t * key_index);
...
fsp_err_t HW_SCE_UpdateAes128KeyIndex(lifecycle_t           lifecycle,
                                      uint8_t             * iv,
                                      uint8_t             * encrypted_key,
                                      sce_aes_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateAes192KeyIndex(lifecycle_t           lifecycle,
                                      uint8_t             * iv,
                                      uint8_t             * encrypted_key,
                                      sce_aes_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateAes256KeyIndex(lifecycle_t           lifecycle,
                                      uint8_t             * iv,
                                      uint8_t             * encrypted_key,
                                      sce_aes_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateAes128XtsKeyIndex(lifecycle_t           lifecycle,
                                         uint8_t             * iv,
                                         uint8_t             * encrypted_key,
                                         sce_aes_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateAes256XtsKeyIndex(lifecycle_t           lifecycle,
                                         uint8_t             * iv,
                                         uint8_t             * encrypted_key,
                                         sce_aes_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateTdesKeyIndex(uint8_t * iv, uint8_t * encrypted_key, sce_tdes_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateRsa1024PublicKeyIndex(uint8_t                        * iv,
                                             uint8_t                        * encrypted_key,
                                             sce_rsa1024_public_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateRsa1024PrivateKeyIndex(uint8_t                         * iv,
                                              uint8_t                         * encrypted_key,
                                              sce_rsa1024_private_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateRsa2048PublicKeyIndex(uint8_t                        * iv,
                                             uint8_t                        * encrypted_key,
                                             sce_rsa2048_public_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateRsa2048PrivateKeyIndex(uint8_t                         * iv,
                                              uint8_t                         * encrypted_key,
                                              sce_rsa2048_private_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateRsa3072PublicKeyIndex(uint8_t                        * iv,
                                             uint8_t                        * encrypted_key,
                                             sce_rsa3072_public_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateRsa3072PrivateKeyIndex(uint8_t                         * iv,
                                              uint8_t                         * encrypted_key,
                                              sce_rsa3072_private_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateRsa4096PublicKeyIndex(uint8_t                        * iv,
                                             uint8_t                        * encrypted_key,
                                             sce_rsa4096_public_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateRsa4096PrivateKeyIndex(uint8_t                         * iv,
                                              uint8_t                         * encrypted_key,
                                              sce_rsa4096_private_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateTlsRsaPublicKeyIndex(uint8_t                                     * iv,
                                            uint8_t                                     * encrypted_key,
                                            sce_tls_ca_certification_public_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateEccP192PublicKeyIndex(uint8_t                    * iv,
                                             uint8_t                    * encrypted_key,
                                             sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateEccP224PublicKeyIndex(uint8_t                    * iv,
                                             uint8_t                    * encrypted_key,
                                             sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateEccP256PublicKeyIndex(uint8_t                    * iv,
                                             uint8_t                    * encrypted_key,
                                             sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateEccP384PublicKeyIndex(uint8_t                    * iv,
                                             uint8_t                    * encrypted_key,
                                             sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateEccP192PrivateKeyIndex(uint8_t                     * iv,
                                              uint8_t                     * encrypted_key,
                                              sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateEccP224PrivateKeyIndex(uint8_t                     * iv,
                                              uint8_t                     * encrypted_key,
                                              sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateEccP256PrivateKeyIndex(uint8_t                     * iv,
                                              uint8_t                     * encrypted_key,
                                              sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_UpdateEccP384PrivateKeyIndex(uint8_t                     * iv,
                                              uint8_t                     * encrypted_key,
                                              sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_Ecc256ScalarMultiplication(uint32_t * InData_CurveType,
                                            uint32_t * InData_Cmd,
...
fsp_err_t HW_SCE_GenerateFirmwareMAC(uint32_t                                  * InData_KeyIndex,
...
fsp_err_t HW_SCE_Aes128EcbEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
...
fsp_err_t HW_SCE_Aes128EcbDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
...
fsp_err_t HW_SCE_Aes128CbcEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
...
fsp_err_t HW_SCE_Aes128CbcDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
...
fsp_err_t HW_SCE_Aes192EcbEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
...
fsp_err_t HW_SCE_Aes192EcbDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
...
fsp_err_t HW_SCE_Aes192CbcEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
...
fsp_err_t HW_SCE_Aes192CbcDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
...
fsp_err_t HW_SCE_Aes256EcbEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
...
fsp_err_t HW_SCE_Aes256EcbDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
...
fsp_err_t HW_SCE_Aes256CbcEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
...
fsp_err_t HW_SCE_Aes256CbcDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
...
fsp_err_t HW_SCE_Aes128CtrEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
...
fsp_err_t HW_SCE_Aes128CtrDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
...
fsp_err_t HW_SCE_Aes192CtrEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
...
fsp_err_t HW_SCE_Aes192CtrDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
...
fsp_err_t HW_SCE_Aes256CtrEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
...
fsp_err_t HW_SCE_Aes256CtrDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
...
fsp_err_t HW_SCE_Aes128XtsEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           text_bitlen);
fsp_err_t HW_SCE_Aes128XtsEncryptFinal(sce_aes_handle_t * handle,
                                       uint8_t          * plain,
                                       uint8_t          * cipher,
                                       uint32_t           text_bitlen);
fsp_err_t HW_SCE_Aes128XtsDecryptInit(sce_aes_handle_t * handle, sce_aes_key_index_t * key_index, uint8_t * ivec);
fsp_err_t HW_SCE_Aes128XtsDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           text_bitlen);
fsp_err_t HW_SCE_Aes128XtsDecryptFinal(sce_aes_handle_t * handle,
                                       uint8_t          * cipher,
                                       uint8_t          * plain,
                                       uint32_t           text_bitlen);
fsp_err_t HW_SCE_Aes256XtsEncryptInit(sce_aes_handle_t * handle, sce_aes_key_index_t * key_index, uint8_t * ivec);
fsp_err_t HW_SCE_Aes256XtsEncryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           text_bitlen);
fsp_err_t HW_SCE_Aes256XtsEncryptFinal(sce_aes_handle_t * handle,
                                       uint8_t          * plain,
                                       uint8_t          * cipher,
                                       uint32_t           text_bitlen);
fsp_err_t HW_SCE_Aes256XtsDecryptInit(sce_aes_handle_t * handle, sce_aes_key_index_t * key_index, uint8_t * ivec);
fsp_err_t HW_SCE_Aes256XtsDecryptUpdate(sce_aes_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           text_bitlen);
fsp_err_t HW_SCE_Aes256XtsDecryptFinal(sce_aes_handle_t * handle,
                                       uint8_t          * cipher,
                                       uint8_t          * plain,
                                       uint32_t           text_bitlen);

fsp_err_t HW_SCE_Aes128GcmEncryptInit(sce_gcm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * ivec,
                                      uint32_t              ivec_len);
fsp_err_t HW_SCE_Aes128GcmEncryptUpdate(sce_gcm_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_data_len,
                                        uint8_t          * aad,
                                        uint32_t           aad_len);
fsp_err_t HW_SCE_Aes128GcmEncryptFinal(sce_gcm_handle_t * handle,
                                       uint8_t          * cipher,
                                       uint32_t         * cipher_data_len,
                                       uint8_t          * atag);
fsp_err_t HW_SCE_Aes128GcmDecryptInit(sce_gcm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * ivec,
                                      uint32_t              ivec_len);
fsp_err_t HW_SCE_Aes128GcmDecryptUpdate(sce_gcm_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_data_len,
                                        uint8_t          * aad,
                                        uint32_t           aad_len);
fsp_err_t HW_SCE_Aes128GcmDecryptFinal(sce_gcm_handle_t * handle,
                                       uint8_t          * plain,
                                       uint32_t         * plain_data_len,
                                       uint8_t          * atag,
                                       uint32_t           atag_len);

fsp_err_t HW_SCE_Aes192GcmEncryptInit(sce_gcm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * ivec,
                                      uint32_t              ivec_len);
fsp_err_t HW_SCE_Aes192GcmEncryptUpdate(sce_gcm_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_data_len,
                                        uint8_t          * aad,
                                        uint32_t           aad_len);
fsp_err_t HW_SCE_Aes192GcmEncryptFinal(sce_gcm_handle_t * handle,
                                       uint8_t          * cipher,
                                       uint32_t         * cipher_data_len,
                                       uint8_t          * atag);
fsp_err_t HW_SCE_Aes192GcmDecryptInit(sce_gcm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * ivec,
                                      uint32_t              ivec_len);
fsp_err_t HW_SCE_Aes192GcmDecryptUpdate(sce_gcm_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_data_len,
                                        uint8_t          * aad,
                                        uint32_t           aad_len);
fsp_err_t HW_SCE_Aes192GcmDecryptFinal(sce_gcm_handle_t * handle,
                                       uint8_t          * plain,
                                       uint32_t         * plain_data_len,
                                       uint8_t          * atag,
                                       uint32_t           atag_len);

fsp_err_t HW_SCE_Aes256GcmEncryptInit(sce_gcm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * ivec,
                                      uint32_t              ivec_len);
fsp_err_t HW_SCE_Aes256GcmEncryptUpdate(sce_gcm_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_data_len,
                                        uint8_t          * aad,
                                        uint32_t           aad_len);
fsp_err_t HW_SCE_Aes256GcmEncryptFinal(sce_gcm_handle_t * handle,
                                       uint8_t          * cipher,
                                       uint32_t         * cipher_data_len,
                                       uint8_t          * atag);
fsp_err_t HW_SCE_Aes256GcmDecryptInit(sce_gcm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * ivec,
                                      uint32_t              ivec_len);
fsp_err_t HW_SCE_Aes256GcmDecryptUpdate(sce_gcm_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_data_len,
                                        uint8_t          * aad,
                                        uint32_t           aad_len);
fsp_err_t HW_SCE_Aes256GcmDecryptFinal(sce_gcm_handle_t * handle,
                                       uint8_t          * plain,
                                       uint32_t         * plain_data_len,
                                       uint8_t          * atag,
                                       uint32_t           atag_len);

fsp_err_t HW_SCE_Aes128CcmEncryptInit(sce_ccm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * nonce,
                                      uint32_t              nonce_len,
                                      uint8_t             * adata,
                                      ...
                                      uint32_t              mac_len);
fsp_err_t HW_SCE_Aes128CcmEncryptUpdate(sce_ccm_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
fsp_err_t HW_SCE_Aes128CcmEncryptFinal(sce_ccm_handle_t * handle,
                                       uint8_t          * cipher,
                                       uint32_t         * cipher_length,
                                       uint8_t          * mac,
                                       uint32_t           mac_length);
fsp_err_t HW_SCE_Aes128CcmDecryptInit(sce_ccm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * nonce,
                                      uint32_t              nonce_len,
                                      uint8_t             * adata,
                                      ...
                                      uint32_t              payload_len,
                                      uint32_t              mac_len);
fsp_err_t HW_SCE_Aes128CcmDecryptUpdate(sce_ccm_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
fsp_err_t HW_SCE_Aes128CcmDecryptFinal(sce_ccm_handle_t * handle,
                                       uint8_t          * plain,
                                       uint32_t         * plain_length,
                                       uint8_t          * mac,
                                       uint32_t           mac_length);

fsp_err_t HW_SCE_Aes192CcmEncryptInit(sce_ccm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * nonce,
                                      uint32_t              nonce_len,
                                      uint8_t             * adata,
                                      ...
                                      uint32_t              payload_len,
                                      uint32_t              mac_len);
fsp_err_t HW_SCE_Aes192CcmEncryptUpdate(sce_ccm_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
fsp_err_t HW_SCE_Aes192CcmEncryptFinal(sce_ccm_handle_t * handle,
                                       uint8_t          * cipher,
                                       uint32_t         * cipher_length,
                                       uint8_t          * mac,
                                       uint32_t           mac_length);
fsp_err_t HW_SCE_Aes192CcmDecryptInit(sce_ccm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * nonce,
                                      uint32_t              nonce_len,
                                      uint8_t             * adata,
                                      ...
                                      uint32_t              payload_len,
                                      uint32_t              mac_len);
fsp_err_t HW_SCE_Aes192CcmDecryptUpdate(sce_ccm_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
fsp_err_t HW_SCE_Aes192CcmDecryptFinal(sce_ccm_handle_t * handle,
                                       uint8_t          * plain,
                                       uint32_t         * plain_length,
                                       uint8_t          * mac,
                                       uint32_t           mac_length);

fsp_err_t HW_SCE_Aes256CcmEncryptInit(sce_ccm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * nonce,
                                      uint32_t              nonce_len,
                                      uint8_t             * adata,
                                      ...
                                      uint32_t              payload_len,
                                      uint32_t              mac_len);
fsp_err_t HW_SCE_Aes256CcmEncryptUpdate(sce_ccm_handle_t * handle,
                                        uint8_t          * plain,
                                        uint8_t          * cipher,
                                        uint32_t           plain_length);
fsp_err_t HW_SCE_Aes256CcmEncryptFinal(sce_ccm_handle_t * handle,
                                       uint8_t          * cipher,
                                       uint32_t         * cipher_length,
                                       uint8_t          * mac,
                                       uint32_t           mac_length);
fsp_err_t HW_SCE_Aes256CcmDecryptInit(sce_ccm_handle_t    * handle,
                                      sce_aes_key_index_t * key_index,
                                      uint8_t             * nonce,
                                      uint32_t              nonce_len,
                                      uint8_t             * adata,
                                      ...
                                      uint32_t              payload_len,
                                      uint32_t              mac_len);
fsp_err_t HW_SCE_Aes256CcmDecryptUpdate(sce_ccm_handle_t * handle,
                                        uint8_t          * cipher,
                                        uint8_t          * plain,
                                        uint32_t           cipher_length);
fsp_err_t HW_SCE_Aes256CcmDecryptFinal(sce_ccm_handle_t * handle,
                                       uint8_t          * plain,
                                       uint32_t         * plain_length,
                                       uint8_t          * mac,
                                       uint32_t           mac_length);
...
fsp_err_t HW_SCE_TdesEcbEncryptUpdate(sce_tdes_handle_t * handle,
                                      uint8_t           * plain,
                                      uint8_t           * cipher,
                                      uint32_t            plain_length);
...
fsp_err_t HW_SCE_TdesEcbDecryptUpdate(sce_tdes_handle_t * handle,
                                      uint8_t           * cipher,
                                      uint8_t           * plain,
                                      uint32_t            cipher_length);
...
fsp_err_t HW_SCE_TdesCbcEncryptUpdate(sce_tdes_handle_t * handle,
                                      uint8_t           * plain,
                                      uint8_t           * cipher,
                                      uint32_t            plain_length);
...
fsp_err_t HW_SCE_TdesCbcDecryptUpdate(sce_tdes_handle_t * handle,
                                      uint8_t           * cipher,
                                      uint8_t           * plain,
                                      uint32_t            cipher_length);
...
fsp_err_t HW_SCE_Sha256HmacGenerateUpdate(sce_hmac_sha_handle_t * handle, uint8_t * message, uint32_t message_length);
...
fsp_err_t HW_SCE_RsaesPkcs1024Encrypt(sce_rsa_byte_data_t            * plain,
                                      sce_rsa_byte_data_t            * cipher,
                                      sce_rsa1024_public_key_index_t * key_index);
fsp_err_t HW_SCE_RsaesPkcs1024Decrypt(sce_rsa_byte_data_t             * cipher,
                                      sce_rsa_byte_data_t             * plain,
                                      sce_rsa1024_private_key_index_t * key_index);
fsp_err_t HW_SCE_RsaesPkcs2048Encrypt(sce_rsa_byte_data_t            * plain,
                                      sce_rsa_byte_data_t            * cipher,
                                      sce_rsa2048_public_key_index_t * key_index);
fsp_err_t HW_SCE_RsaesPkcs2048Decrypt(sce_rsa_byte_data_t             * cipher,
                                      sce_rsa_byte_data_t             * plain,
                                      sce_rsa2048_private_key_index_t * key_index);
fsp_err_t HW_SCE_RsaesPkcs3072Encrypt(sce_rsa_byte_data_t            * plain,
                                      sce_rsa_byte_data_t            * cipher,
                                      sce_rsa3072_public_key_index_t * key_index);
fsp_err_t HW_SCE_RsaesPkcs3072Decrypt(sce_rsa_byte_data_t             * cipher,
                                      sce_rsa_byte_data_t             * plain,
                                      sce_rsa3072_private_key_index_t * key_index);
fsp_err_t HW_SCE_RsaesPkcs4096Encrypt(sce_rsa_byte_data_t            * plain,
                                      sce_rsa_byte_data_t            * cipher,
                                      sce_rsa4096_public_key_index_t * key_index);
fsp_err_t HW_SCE_RsaesPkcs4096Decrypt(sce_rsa_byte_data_t             * cipher,
                                      sce_rsa_byte_data_t             * plain,
                                      sce_rsa4096_private_key_index_t * key_index);

fsp_err_t HW_SCE_TlsRootCertificateVerification(uint32_t   public_key_type,
                                                uint8_t  * certificate,
...
fsp_err_t HW_SCE_TlsCertificateVerification(uint32_t   public_key_type,
...
fsp_err_t HW_SCE_TlsGenerateMasterSecret(uint32_t   select_cipher_suite,
...
fsp_err_t HW_SCE_TlsGenerateSessionKey(uint32_t                   select_cipher_suite,
                                       uint32_t                 * sce_master_secret,
                                       uint8_t                  * client_random,
                                       uint8_t                  * server_random,
                                       uint8_t                  * nonce_explicit,
                                       sce_hmac_sha_key_index_t * client_mac_key_index,
                                       sce_hmac_sha_key_index_t * server_mac_key_index,
                                       sce_aes_key_index_t      * client_crypto_key_index,
                                       sce_aes_key_index_t      * server_crypto_key_index,
                                       uint8_t                  * client_iv,
                                       uint8_t                  * server_iv);
fsp_err_t HW_SCE_TlsGenerateVerifyData(uint32_t   select_verify_data,
                                       uint32_t * sce_master_secret,
                                       uint8_t  * hand_shake_hash,
                                       uint8_t  * verify_data);
fsp_err_t HW_SCE_TlsGeneratePreMasterSecretWithEccP256Key(uint32_t                     * encrypted_public_key,
                                                          sce_tls_p256_ecc_key_index_t * tls_p256_ecc_key_index,
                                                          uint32_t                     * sce_pre_master_secret);
fsp_err_t HW_SCE_TlsServersEphemeralEcdhPublicKeyRetrieves(uint32_t   public_key_type,
                                                           uint8_t  * client_random,
                                                           uint8_t  * server_random,
...
fsp_err_t HW_SCE_EcdsaP192SignatureGenerate(sce_ecdsa_byte_data_t       * message_hash,
                                            sce_ecdsa_byte_data_t       * signature,
                                            sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_EcdsaP224SignatureGenerate(uint32_t                    * indata_curvetype,
                                            sce_ecdsa_byte_data_t       * message_hash,
                                            sce_ecdsa_byte_data_t       * signature,
                                            sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_EcdsaP256SignatureGenerate(uint32_t                    * indata_curvetype,
                                            sce_ecdsa_byte_data_t       * message_hash,
                                            sce_ecdsa_byte_data_t       * signature,
                                            sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_EcdsaP384SignatureGenerate(uint32_t                    * indata_curvetype,
                                            sce_ecdsa_byte_data_t       * message_hash,
                                            sce_ecdsa_byte_data_t       * signature,
                                            sce_ecc_private_key_index_t * key_index);
fsp_err_t HW_SCE_EcdsaP192SignatureVerification(sce_ecdsa_byte_data_t      * signature,
                                                sce_ecdsa_byte_data_t      * message_hash,
                                                sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_EcdsaP224SignatureVerification(uint32_t                   * indata_curvetype,
                                                sce_ecdsa_byte_data_t      * signature,
                                                sce_ecdsa_byte_data_t      * message_hash,
                                                sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_EcdsaP256SignatureVerification(uint32_t                   * indata_curvetype,
                                                sce_ecdsa_byte_data_t      * signature,
                                                sce_ecdsa_byte_data_t      * message_hash,
                                                sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_EcdsaP384SignatureVerification(uint32_t                   * indata_curvetype,
                                                sce_ecdsa_byte_data_t      * signature,
                                                sce_ecdsa_byte_data_t      * message_hash,
                                                sce_ecc_public_key_index_t * key_index);
...
fsp_err_t HW_SCE_EcdhReadPublicKey(sce_ecdh_handle_t          * handle,
                                   sce_ecc_public_key_index_t * public_key_index,
                                   uint8_t                    * public_key_data,
                                   sce_ecdsa_byte_data_t      * signature,
                                   sce_ecc_public_key_index_t * key_index);
fsp_err_t HW_SCE_EcdhMakePublicKey(sce_ecdh_handle_t           * handle,
                                   sce_ecc_public_key_index_t  * public_key_index,
                                   sce_ecc_private_key_index_t * private_key_index,
                                   uint8_t                     * public_key,
                                   sce_ecdsa_byte_data_t       * signature,
                                   sce_ecc_private_key_index_t * key_index);
...
fsp_err_t HW_SCE_EcdhKeyDerivation(sce_ecdh_handle_t    * handle,
                                   sce_ecdh_key_index_t * shared_secret_index,
...
fsp_err_t HW_SCE_Aes128KeyWrap(sce_aes_key_index_t * wrap_key_index,
                               uint32_t              target_key_type,
                               sce_aes_key_index_t * target_key_index,
                               uint32_t            * wrapped_key);
fsp_err_t HW_SCE_Aes256KeyWrap(sce_aes_key_index_t * wrap_key_index,
                               uint32_t              target_key_type,
                               sce_aes_key_index_t * target_key_index,
                               uint32_t            * wrapped_key);
fsp_err_t HW_SCE_Aes128KeyUnwrap(sce_aes_key_index_t * wrap_key_index,
                                 uint32_t              target_key_type,
                                 uint32_t            * wrapped_key,
                                 sce_aes_key_index_t * target_key_index);
fsp_err_t HW_SCE_Aes256KeyUnwrap(sce_aes_key_index_t * wrap_key_index,
                                 uint32_t              target_key_type,
                                 uint32_t            * wrapped_key,
                                 sce_aes_key_index_t * target_key_index);

                                     ...
                                     uint32_t       OutData_DataT[])
{
    ...
    HW_SCE_p_func100(0x293d5756U, 0xd0d5e319U, 0x31ea42a7U, 0xc891eba4U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0xc69c490fU, 0x283ad240U, 0x724aedbfU, 0x50dde871U);
    ...
    else
    {
        if ((InData_Cmd[0] == 0x00000000U) || (InData_Cmd[0] == 0x00000002U))
        {
            ...
            HW_SCE_p_func101(0x8e341542U, 0x8de388deU, 0x55a23c5fU, 0xef3e062bU);
        }
        else
        {
            WR1_PROG(REG_1444H, 0x000000a1U);
            ...
            HW_SCE_p_func101(0x3f4252b8U, 0xe13915dcU, 0x3060cf5cU, 0xf7ef6514U);
        }
        ...
        {
            HW_SCE_p_func100(0xa37920a9U, 0x6a1cc4eaU, 0xd93db6a1U, 0xc4ef4f49U);
            ...
            HW_SCE_p_func102(0x4bd20fedU, 0xbae3e53cU, 0xc6722c89U, 0x948ccf0aU);
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        else
        {
            ...
            HW_SCE_p_func100(0xaf331305U, 0x1e995aacU, 0xcafcd6bfU, 0x25d3eb6eU);
            WR1_PROG(REG_143CH, 0x00400000U);

            if (CHCK_STS(REG_143CH, 22, 1))
            {
                HW_SCE_p_func102(0x88b12fd1U, 0x2f201576U, 0x85fa2658U, 0x4c2a7920U);
                WR1_PROG(REG_14BCH, 0x00000040U);
                WAIT_STS(REG_142CH, 12, 0);
            ...
            else
            {
                ...
                HW_SCE_p_func100(0x29d7b781U, 0x57885f43U, 0x8b1c97c7U, 0xd369b19dU);
                WR1_PROG(REG_143CH, 0x00400000U);

                if (CHCK_STS(REG_143CH, 22, 1))
                {
                    HW_SCE_p_func102(0x8e1d2d10U, 0xd5d34210U, 0xfb3a950fU, 0x43262bb6U);
                    WR1_PROG(REG_14BCH, 0x00000040U);
                    WAIT_STS(REG_142CH, 12, 0);
                ...
                {
                    HW_SCE_p_func102(0x93889a63U, 0x41131731U, 0xf9eb88aeU, 0x8d54328fU);
                    WR1_PROG(REG_14BCH, 0x00000040U);
                    WAIT_STS(REG_142CH, 12, 0);

...
void HW_SCE_Chacha20UpdateSub (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    uint32_t iLoop = 0U;
    ...
    HW_SCE_p_func101(0xc28999d4U, 0x910641efU, 0x1351b04cU, 0x9c1c62a9U);
}

...
void HW_SCE_p_func086 (const uint32_t ARG1[])
{
    uint32_t iLoop = 0U;
    ...
    for (iLoop = 44; iLoop < 64U; iLoop = iLoop + 4U)
    {
        WAIT_STS(REG_1444H, 31, 1);
    ...
    for (iLoop = 64; iLoop < 84; iLoop = iLoop + 4U)
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &ARG1[iLoop]);
        WR1_PROG(REG_1400H, 0x00c20011U);
    ...
    for (iLoop = 84; iLoop < 104; iLoop = iLoop + 4U)
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &ARG1[iLoop]);
        WR1_PROG(REG_1400H, 0x00c20011U);
    ...
    for (iLoop = 104; iLoop < 124; iLoop = iLoop + 4U)
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &ARG1[iLoop]);
        WR1_PROG(REG_1400H, 0x00c20011U);
    ...
    for (iLoop = 124; iLoop < 144; iLoop = iLoop + 4U)
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &ARG1[iLoop]);
        WR1_PROG(REG_1400H, 0x00c20011U);
    ...
    for (iLoop = 144; iLoop < 164; iLoop = iLoop + 4U)
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &ARG1[iLoop]);
        WR1_PROG(REG_1400H, 0x00c20011U);

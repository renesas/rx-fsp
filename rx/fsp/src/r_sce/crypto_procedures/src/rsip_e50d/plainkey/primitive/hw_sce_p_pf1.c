                                                ...
                                                const uint32_t InData_DomainParam[])
{
    ...
    HW_SCE_p_func100(0xfafee0e9U, 0x82e19224U, 0xda0920c6U, 0xd1e53ce1U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0xd5fa557fU, 0x92eb57a9U, 0x34148a4eU, 0x526e0004U);
    ...
    else
    {
        ...
        HW_SCE_p_func101(0x37942b82U, 0x18b31f9cU, 0xebf8a326U, 0x57f97a07U);
        HW_SCE_p_func073(InData_DomainParam);

        HW_SCE_p_func100(0x6dad85b1U, 0xcb34437aU, 0xfa9b614fU, 0xe04c2e60U);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0xd9f7d0b6U, 0xa72382c8U, 0x1ae0c86cU, 0x231fec91U);
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func102(0x4727ebbfU, 0x765ea6a9U, 0xa7ad5507U, 0xad5542e6U);
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);

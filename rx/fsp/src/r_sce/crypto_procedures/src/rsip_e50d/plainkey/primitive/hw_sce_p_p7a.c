                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0x4e7eab35U, 0x496a7dc9U, 0x04ebb862U, 0x7e55191aU);
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        HW_SCE_p_func101(0x1049610dU, 0x1bef1762U, 0x6cd54281U, 0xac891a2dU);
        HW_SCE_p_func043();
        ...
        HW_SCE_p_func101(0xe375f980U, 0xa30fc7daU, 0x1a145ae3U, 0x38333d02U);
        HW_SCE_p_func044();
        ...
        HW_SCE_p_func101(0xc2a1bb72U, 0x7f8a9e07U, 0x39308ce5U, 0xc6830cf3U);
    }
    else
    {
        WR1_PROG(REG_1444H, 0x0000bfc2U);
        ...
        HW_SCE_p_func101(0x3095eaedU, 0x9566e222U, 0xecd58d47U, 0x2cc3b3c0U);
    }

    HW_SCE_p_func100(0x675dd7d1U, 0x45bd6d1dU, 0xbaecc8b7U, 0xaee0063cU);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0xe84a5235U, 0x74eb43b2U, 0x949acd2aU, 0x01249594U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x5669460cU, 0xe12f80c7U, 0xca9b7349U, 0x3654b7c7U);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x4f1c1a6aU, 0xb63a2b89U, 0xede09603U, 0x48c2b3a8U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func100(0xa1230229U, 0x9bc06cedU, 0x8d97eb44U, 0x09171a2fU);
            ...
            for (iLoop = 0U; iLoop < 96U; iLoop = iLoop + 8U)
            {
                ...
                HW_SCE_p_func100(0x875e6389U, 0x6b6efabbU, 0x0c628ddeU, 0x9bf1b61cU);
                ...
                HW_SCE_p_func101(0x1a2d3026U, 0xfb43cc95U, 0xaf1fcad2U, 0x850fcea6U);
            }
            ...
            HW_SCE_p_func100(0x904178b4U, 0x5c339fb0U, 0x797b9b5eU, 0xb8397252U);
            WR1_PROG(REG_1408H, 0x00020000U);

            HW_SCE_p_func102(0x32386981U, 0x1c43f097U, 0x9bcbf868U, 0x0573431eU);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);

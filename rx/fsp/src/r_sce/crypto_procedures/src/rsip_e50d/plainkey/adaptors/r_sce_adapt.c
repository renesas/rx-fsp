...
const uint32_t sce_oem_key_size[SCE_OEM_CMD_NUM] =
{
    ...
    SCE_OEM_KEY_SIZE_DUMMY_INST_DATA_WORD,
    SCE_OEM_KEY_SIZE_DUMMY_INST_DATA_WORD,
    SCE_OEM_KEY_SIZE_CHACHA20_POLY_1305_KEY_INST_DATA_WORD,
};
...
/* RSIP specific initialization functions */
/* returns fsp_err_t                      */
...
fsp_err_t HW_SCE_Aes192EncryptDecryptInitSubAdaptor (const uint32_t InData_KeyMode[],
                                                     ...
                                                     const uint32_t InData_IV[])
{
    return HW_SCE_Aes192EncryptDecryptInitSub(InData_KeyMode, InData_Cmd, InData_KeyIndex, InData_Key, InData_IV);
}
...
{
    return HW_SCE_Aes192CmacInitSub(InData_KeyType, InData_KeyIndex, NULL);
}
                                                 ...
                                                 uint32_t * InData_SeqNum)
{
    ...
    return HW_SCE_Aes192GcmEncryptInitSub(InData_KeyType, InData_KeyIndex, NULL, InData_IV);
}
                                                 ...
                                                 uint32_t * InData_SeqNum)
{
    ...
    return HW_SCE_Aes192GcmDecryptInitSub(InData_KeyType, InData_KeyIndex, NULL, InData_IV);
}
                                                 ...
                                                 uint32_t Header_Len)
{
    ...
    return HW_SCE_Aes128CcmEncryptInitSub(InData_KeyType,
                                          InData_TextLen,
                                          InData_KeyIndex,
                                          NULL,
                                          InData_IV,
                                                 ...
                                                 uint32_t Header_Len)
{
    ...
    return HW_SCE_Aes192CcmEncryptInitSub(InData_KeyType, InData_KeyIndex, NULL, InData_IV, InData_Header, Header_Len);
}
                                                 ...
                                                 uint32_t Header_Len)
{
    ...
    return HW_SCE_Aes128CcmDecryptInitSub(InData_KeyType,
                                          InData_TextLen,
                                          InData_MACLength,
                                          InData_KeyIndex,
                                          NULL,
                                                 ...
                                                 uint32_t Header_Len)
{
    ...
    return HW_SCE_Aes192CcmDecryptInitSub(InData_KeyType, InData_KeyIndex, NULL, InData_IV, InData_Header, Header_Len);
}
...
fsp_err_t HW_SCE_Aes128CcmEncryptFinalSubGeneral (const uint32_t * InData_Text,
                                                       ...
                                                       uint32_t       OutData_R[])
{
    ...
    return HW_SCE_Ecc256ScalarMultiplicationSub(InData_CurveType,
                                                InData_Cmd,
                                                &indata_key_type,
                                                InData_KeyIndex,
                                                NULL,
                                                       ...
                                                       uint32_t       OutData_R[])
{
    ...
    return HW_SCE_Ecc384ScalarMultiplicationSub(InData_CurveType,
                                                &indata_key_type,
                                                InData_KeyIndex,
                                                NULL,
                                                InData_PubKey,
                                                       ...
                                                       uint32_t       OutData_R[])
{
    ...
    return HW_SCE_Ecc521ScalarMultiplicationSub(&indata_key_type,
                                                InData_KeyIndex,
                                                NULL,
                                                InData_PubKey,
                                                InData_DomainParam,
                                                           ...
                                                           uint32_t       OutData_R[])
{
    ...
    return HW_SCE_Ed25519ScalarMultiplicationSub(&indata_key_type,
                                                 InData_KeyIndex,
                                                 NULL,
                                                 InData_PubKey,
                                                 InData_DomainParam,
                                                       ...
                                                       uint32_t       OutData_Signature[])
{
    ...
    return HW_SCE_EcdsaP521SignatureGenerateSub(&indata_key_type,
                                                InData_KeyIndex,
                                                NULL,
                                                InData_MsgDgst,
                                                InData_DomainParam,
                                                           ...
                                                           const uint32_t InData_DomainParam[])
{
    ...
    return HW_SCE_EcdsaP521SignatureVerificationSub(InData_Key, InData_MsgDgst, InData_Signature, InData_DomainParam);
}
                                                      ...
                                                      uint32_t       * OutData_PrivKey)
{
    ...
    return HW_SCE_GenerateEccRandomKeyIndexSub(InData_KeyType,
                                               InData_CurveType,
                                               InData_Cmd,
                                               InData_DomainParam,
                                               OutData_PubKey,
                                                   ...
                                                   uint32_t * OutData_PrivKey)
{
    ...
    return HW_SCE_RSA2048_KeyPairGenerateSub(InData_KeyType,
                                             OutData_PubKey,
                                             OutData_PrivKeyIndex,
                                             OutData_PrivKey,
                                             MAX_CNT);
...
fsp_err_t HW_SCE_Aes128OutputKeyForDotfSubAdaptor (const uint32_t InData_Cmd[],
                                                   uint32_t       InData_KeyIndex[],
                                                   uint32_t       InData_DOTFSEED[])
{
...
fsp_err_t HW_SCE_Aes192OutputKeyForDotfSubAdaptor (const uint32_t InData_Cmd[],
                                                   uint32_t       InData_KeyIndex[],
                                                   uint32_t       InData_DOTFSEED[])
{
    uint32_t indata_key_mode[1] = {0};
...
fsp_err_t HW_SCE_Aes256OutputKeyForDotfSubAdaptor (const uint32_t InData_Cmd[],
                                                   uint32_t       InData_KeyIndex[],
                                                   uint32_t       InData_DOTFSEED[])
{
    uint32_t indata_key_mode[1] = {0};
                                                   ...
                                                   uint32_t       OutData_PrivKey[])
{
    ...
    return HW_SCE_RSA3072_KeyPairGenerateSub(InData_KeyMode,
                                             OutData_PubKey,
                                             OutData_PrivKeyIndex,
                                             OutData_PrivKey,
                                             MAX_CNT);
...
fsp_err_t HW_SCE_GenerateEccP521RandomKeyIndexSubAdaptor (const uint32_t InData_KeyMode[],
                                                          ...
                                                          uint32_t       OutData_PrivKey[])
{
    return HW_SCE_GenerateEccP521RandomKeyIndexSub(InData_KeyMode,
                                                   InData_DomainParam,
                                                   OutData_PubKey,
                                                   OutData_PrivKeyIndex,
                                                   OutData_PrivKey);
...
fsp_err_t HW_SCE_Rsa2048ModularExponentDecryptSubAdaptor (const uint32_t InData_KeyMode[],
                                                          ...
                                                          uint32_t       OutData_Text[])
{
    return HW_SCE_Rsa2048ModularExponentDecryptSub(InData_KeyMode,
                                                   InData_KeyIndex,
                                                   InData_Key,
                                                   InData_Text,
                                                   OutData_Text);
...
fsp_err_t HW_SCE_Rsa3072ModularExponentDecryptSubAdaptor (const uint32_t InData_KeyMode[],
                                                          ...
                                                          uint32_t       OutData_Text[])
{
    return HW_SCE_Rsa3072ModularExponentDecryptSub(InData_KeyMode,
                                                   InData_KeyIndex,
                                                   InData_Key,
                                                   InData_Text,
                                                   OutData_Text);
...
fsp_err_t HW_SCE_Rsa4096ModularExponentDecryptSubAdaptor (const uint32_t InData_KeyMode[],
                                                          ...
                                                          uint32_t       OutData_Text[])
{
    return HW_SCE_Rsa4096ModularExponentDecryptSub(InData_KeyMode,
                                                   InData_KeyIndex,
                                                   InData_Key,
                                                   InData_Text,
                                                   OutData_Text);
                                                          ...
                                                          uint32_t       OutData_Text[])
{
    ...
    return HW_SCE_Rsa2048ModularExponentEncryptSub(InData_Key, InData_Text, OutData_Text);
}
                                                          ...
                                                          uint32_t       OutData_Text[])
{
    ...
    return HW_SCE_Rsa3072ModularExponentEncryptSub(InData_Key, InData_Text, OutData_Text);
}
                                                          ...
                                                          uint32_t       OutData_Text[])
{
    ...
    return HW_SCE_Rsa4096ModularExponentEncryptSub(InData_Key, InData_Text, OutData_Text);
}
...
{
    FSP_PARAMETER_NOT_USED(OutData_PubKeyIndex);
    return HW_SCE_RSA4096_KeyPairGenerateSub(InData_KeyMode, OutData_PubKey, OutData_PrivKeyIndex, OutData_PrivKey, MAX_CNT);
}

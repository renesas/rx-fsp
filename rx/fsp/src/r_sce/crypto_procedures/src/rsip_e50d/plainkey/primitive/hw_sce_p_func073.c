...
void HW_SCE_p_func073 (const uint32_t ARG1[])
{
    ...
    HW_SCE_p_func100(0xf865ada8U, 0xe1f8722bU, 0x28d0f210U, 0x9568cf7eU);
    ...
    HW_SCE_p_func100(0x71e659deU, 0x0161848eU, 0xfa89ac7eU, 0x3e0497adU);
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        HW_SCE_p_func101(0xa6ed0493U, 0x78b37857U, 0xb01cbd5fU, 0xba7bdb60U);
    }
    else
    {
        HW_SCE_p_func100(0x1d6d700cU, 0x1cd26f12U, 0x27872104U, 0x04b21450U);
        ...
        HW_SCE_p_func100(0x83954773U, 0xa5d4d018U, 0xd4ac1ffcU, 0x1d173632U);
        ...
        HW_SCE_p_func100(0x0846bb96U, 0x13d18292U, 0x1dfef793U, 0xf29cb33fU);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func100(0x768dc078U, 0xab0c3587U, 0x44cb2540U, 0x0952f2fdU);
            ...
            HW_SCE_p_func101(0x5726f8d4U, 0x53df3e23U, 0xc12a7e86U, 0x8eea7bf0U);
        }
        else
        {
            WR1_PROG(REG_1404H, 0x14100000U);
            ...
            HW_SCE_p_func101(0x60718526U, 0x28038911U, 0xafcd69e2U, 0x9fdaf1c0U);
        }

        HW_SCE_p_func100(0xcac1ebd6U, 0x0624a3b5U, 0x915400f2U, 0x19984a50U);
        WR1_PROG(REG_143CH, 0x00400000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            HW_SCE_p_func101(0x784645f8U, 0xef51877eU, 0x12f6ec23U, 0x2c675ea4U);
        }
        else
        {
            HW_SCE_p_func100(0xc23c463aU, 0xa9ce0587U, 0xeba71955U, 0x858fb330U);
            WR1_PROG(REG_1404H, 0x11e00000U);
            WR1_PROG(REG_1400H, 0x00c00021U);
            WAIT_STS(REG_1404H, 30, 0);
            WR1_PROG(REG_143CH, 0x00001800U);
            ...
            HW_SCE_p_func100(0xa208cdb1U, 0x0b9fd166U, 0xf4e53894U, 0xff830bedU);
            WR1_PROG(REG_143CH, 0x00400000U);
            ...
            if (CHCK_STS(REG_143CH, 22, 1))
            {
                ...
                HW_SCE_p_func101(0xddcface3U, 0xe1ca57b6U, 0x3c323b6dU, 0xecbae48aU);
            }
            else
            {
                ...
                HW_SCE_p_func100(0x0afbc756U, 0x34022138U, 0xe1d0230cU, 0xa271124bU);
                WR1_PROG(REG_143CH, 0x00400000U);
                ...
                if (CHCK_STS(REG_143CH, 22, 1))
                {
                    ...
                    HW_SCE_p_func101(0xab945b0aU, 0x50a312ebU, 0x90ee39f8U, 0xa0eefc0fU);
                }
                else
                {
                    ...
                    HW_SCE_p_func101(0xd4ab5d25U, 0x94db096fU, 0x56876f69U, 0xdd36e763U);
                }

                HW_SCE_p_func100(0xf5eac91eU, 0xb0e00902U, 0x74f24eb1U, 0x9f996429U);
                WR1_PROG(REG_143CH, 0x00400000U);
                ...
                if (CHCK_STS(REG_143CH, 22, 1))
                {
                    ...
                    HW_SCE_p_func101(0x6fdcb63bU, 0x9315bb3eU, 0x0c74bf72U, 0x509c6d7bU);
                }
                else
                {
                    HW_SCE_p_func100(0x460c3fcdU, 0x69e0af13U, 0x9ff7c406U, 0x933e651aU);
                    ...
                    HW_SCE_p_func100(0x43ef0b1aU, 0x5e9c1b83U, 0x0cd3263dU, 0x808d5732U);
                    WR1_PROG(REG_143CH, 0x00400000U);
                    ...
                    if (CHCK_STS(REG_143CH, 22, 1))
                    {
                        ...
                        HW_SCE_p_func101(0x8655777dU, 0xf53ad4d3U, 0xf6f6f5f8U, 0xf51131daU);
                    }
                    else
                    {
                        ...
                        HW_SCE_p_func101(0xa7dd5f0dU, 0x6694e702U, 0xc9d81dc4U, 0x0800e0d6U);
                    }
                }
            }
        }

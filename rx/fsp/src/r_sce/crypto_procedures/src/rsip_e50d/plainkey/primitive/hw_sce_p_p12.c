                                                    ...
                                                    const uint32_t InData_DomainParam[])
{
    ...
    HW_SCE_p_func100(0x850741c0U, 0x26f0aff4U, 0x7a449bc1U, 0xca1759c1U);
    ...
    HW_SCE_p_func100(0x01d4acd6U, 0xab7a5edbU, 0xda22d264U, 0xbeda252aU);
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        HW_SCE_p_func101(0x3f41647aU, 0xc783b44fU, 0x6b812e70U, 0x44f30332U);
    }
    else
    {
        HW_SCE_p_func100(0xd9868b23U, 0x43282afeU, 0xbed42eb7U, 0xdece5624U);
        ...
        HW_SCE_p_func100(0xbc4e1ff3U, 0x11529959U, 0x81786a3bU, 0x65af2facU);
        WR1_PROG(REG_1010H, 0x00000018U);
        ...
        HW_SCE_p_func100(0x04404923U, 0x8d8c88ecU, 0xe43220eaU, 0x289a9856U);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func100(0x33c0de55U, 0xaf3d925aU, 0x810ef4acU, 0xab640a9aU);
            ...
            HW_SCE_p_func101(0x4ef0a2cdU, 0x8780621cU, 0x3ec6fb50U, 0xb1ac5538U);
        }
        else
        {
            WR1_PROG(REG_1404H, 0x13980000U);
            ...
            HW_SCE_p_func101(0x2a861653U, 0xf1791f79U, 0x6e78edf3U, 0x7dd117b6U);
        }

        HW_SCE_p_func100(0x30fb2c66U, 0x5839bf5cU, 0x849e19ccU, 0x479c8048U);
        WR1_PROG(REG_143CH, 0x00400000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            HW_SCE_p_func101(0x0fb876a6U, 0x3d8e411aU, 0x03bc8fdbU, 0xabb88007U);
        }
        else
        {
            HW_SCE_p_func100(0xf46be8c4U, 0x51cf1502U, 0x7736ee66U, 0x05d84e2aU);
            ...
            HW_SCE_p_func100(0x85e46ce9U, 0x48fac262U, 0x07caf64bU, 0x1e33b513U);
            WR1_PROG(REG_143CH, 0x00400000U);
            ...
            if (CHCK_STS(REG_143CH, 22, 1))
            {
                ...
                HW_SCE_p_func101(0x36db36e8U, 0xea146921U, 0x16fc7489U, 0x4f2cb15aU);
            }
            else
            {
                ...
                HW_SCE_p_func100(0x3eb4c44fU, 0x6a100620U, 0x92435f99U, 0x25a34a47U);
                WR1_PROG(REG_143CH, 0x00400000U);
                ...
                if (CHCK_STS(REG_143CH, 22, 1))
                {
                    ...
                    HW_SCE_p_func101(0x00dd707fU, 0x7593ef36U, 0xeada1c30U, 0xc249deb8U);
                }
                else
                {
                    ...
                    HW_SCE_p_func101(0xe7502477U, 0x2eb7a087U, 0x9b7d4320U, 0xc66891cdU);
                }

                HW_SCE_p_func100(0x9a87fec1U, 0xddbc2febU, 0xf5050b52U, 0x5d21c86fU);
                WR1_PROG(REG_143CH, 0x00400000U);
                ...
                if (CHCK_STS(REG_143CH, 22, 1))
                {
                    ...
                    HW_SCE_p_func101(0x09f0fb2bU, 0x5b907aabU, 0xee15e85fU, 0x51da4929U);
                }
                else
                {
                    HW_SCE_p_func100(0x6ac68bb4U, 0x69838c46U, 0x419400acU, 0x1e7955ceU);
                    ...
                    HW_SCE_p_func100(0xe415adb4U, 0x42786187U, 0xea459bafU, 0x7da16f25U);
                    WR1_PROG(REG_143CH, 0x00400000U);
                    ...
                    if (CHCK_STS(REG_143CH, 22, 1))
                    {
                        ...
                        HW_SCE_p_func101(0x6a910964U, 0x09fa80bfU, 0x9f0acfd9U, 0x1a8b9b09U);
                    }
                    else
                    {
                        ...
                        HW_SCE_p_func101(0xd510b1d2U, 0xd7995284U, 0xdd322b62U, 0x452c8600U);
                    }
                }
            }
        }
    ...
    HW_SCE_p_func100(0x4d2a8f11U, 0x113ff11cU, 0x35578308U, 0x2228e409U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0xbee38a2dU, 0x439edee2U, 0xb2669ef0U, 0x6c7dc1ceU);
    ...
    {
        HW_SCE_p_func102(0x543cd5e6U, 0x6c1676f0U, 0x7459fb48U, 0x8b8426deU);
        WR1_PROG(REG_14B8H, 0x00000040U);
        WAIT_STS(REG_142CH, 12, 0);

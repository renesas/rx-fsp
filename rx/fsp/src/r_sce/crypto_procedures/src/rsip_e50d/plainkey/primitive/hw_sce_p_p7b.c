                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0x2c332c12U, 0x556e8b0eU, 0x1f08aa33U, 0x7f9fd512U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x0d5d5958U, 0x9a96af94U, 0x8c5fc7f7U, 0x05479a37U);
    ...
    {
        HW_SCE_p_func100(0x70e85851U, 0xf03b3e05U, 0x8ca45f74U, 0x3f6c7e15U);
        ...
        for (iLoop = 0U; iLoop < 128U; iLoop = iLoop + 8U)
        {
            ...
            HW_SCE_p_func100(0x52e5d611U, 0xd40d1d83U, 0x696f5c85U, 0xefcfbd68U);
            ...
            HW_SCE_p_func101(0x8a65a088U, 0x079b2226U, 0xe7605da1U, 0xbf52eab5U);
        }
        ...
        HW_SCE_p_func100(0x00972e6bU, 0x65148271U, 0xbf1e4e49U, 0x030e61bdU);
        WR1_PROG(REG_1408H, 0x00020000U);

        HW_SCE_p_func102(0xf32f7feaU, 0x00c91c13U, 0x32eb1a21U, 0xa68f419eU);
        WR1_PROG(REG_14B8H, 0x00000040U);
        WAIT_STS(REG_142CH, 12, 0);

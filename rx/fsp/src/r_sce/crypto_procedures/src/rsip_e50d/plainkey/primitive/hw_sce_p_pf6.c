                                                    ...
                                                    const uint32_t InData_DomainParam[])
{
    ...
    HW_SCE_p_func100(0xb6255d11U, 0x85d93c87U, 0xe9c93f39U, 0x2a196179U);
    ...
    HW_SCE_p_func100(0x8ec0e2b1U, 0x57278be4U, 0x880b1a34U, 0xc9154276U);
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        HW_SCE_p_func101(0x5a3df6d2U, 0x2e3272b0U, 0xa121b284U, 0x7ec9151aU);
    }
    else
    {
        HW_SCE_p_func100(0xca1423a9U, 0xdd1a6fa9U, 0x8879e6e7U, 0xd97a2309U);
        ...
        HW_SCE_p_func100(0xfed22fd4U, 0x294971f4U, 0x3a599a87U, 0x0df2343aU);
        ...
        HW_SCE_p_func100(0xd1b6cf66U, 0x73b9c745U, 0x6dbb6debU, 0xc460c8d1U);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func100(0xcefb72c9U, 0xd00626cdU, 0x636c901bU, 0xa3e6f8e2U);
            ...
            HW_SCE_p_func101(0x88cea692U, 0x0bd8aff9U, 0xa00613b5U, 0xfa5bba92U);
        }
        else
        {
            WR1_PROG(REG_1404H, 0x13e00000U);
            ...
            HW_SCE_p_func101(0xb132c75bU, 0xdc5338e7U, 0xac67774aU, 0xf3d95ae2U);
        }

        HW_SCE_p_func100(0xd0415294U, 0x7745e462U, 0x3d4ed0a2U, 0x929178ccU);
        WR1_PROG(REG_143CH, 0x00400000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            HW_SCE_p_func101(0x2c01ab4eU, 0x052e0881U, 0xd19fd2f4U, 0x4e0ccc75U);
        }
        else
        {
            HW_SCE_p_func100(0xf392e659U, 0x89b968baU, 0x3decc055U, 0x6a4107deU);
            ...
            HW_SCE_p_func100(0xbde06072U, 0x00494d13U, 0x651edc4dU, 0x4ecbd734U);
            WR1_PROG(REG_143CH, 0x00400000U);
            ...
            if (CHCK_STS(REG_143CH, 22, 1))
            {
                ...
                HW_SCE_p_func101(0x9eb64ffeU, 0xd2b63935U, 0xcd2ddea7U, 0x68e51699U);
            }
            else
            {
                ...
                HW_SCE_p_func100(0x411b52f8U, 0x537203a4U, 0x43ca5f85U, 0x1c21ca47U);
                WR1_PROG(REG_143CH, 0x00400000U);
                ...
                if (CHCK_STS(REG_143CH, 22, 1))
                {
                    ...
                    HW_SCE_p_func101(0x5c11672fU, 0x32d96fe9U, 0x700d4310U, 0x9ca4cddeU);
                }
                else
                {
                    ...
                    HW_SCE_p_func101(0x26fbf6f3U, 0xf09fef33U, 0x99fd825fU, 0x6e26443dU);
                }

                HW_SCE_p_func100(0xbd7ea736U, 0xae4fa1a6U, 0x3a6bf9a6U, 0xc86dfd6eU);
                WR1_PROG(REG_143CH, 0x00400000U);
                ...
                if (CHCK_STS(REG_143CH, 22, 1))
                {
                    ...
                    HW_SCE_p_func101(0x37aa14b6U, 0x9130b018U, 0x527ffb77U, 0x8ea46b3cU);
                }
                else
                {
                    HW_SCE_p_func100(0x39b9f1d3U, 0x28a8f299U, 0xf0505d07U, 0x7ddad30eU);
                    ...
                    HW_SCE_p_func100(0xab2e4958U, 0x0c8a8936U, 0xe7ad360cU, 0x23b8acf1U);
                    WR1_PROG(REG_143CH, 0x00400000U);
                    ...
                    if (CHCK_STS(REG_143CH, 22, 1))
                    {
                        ...
                        HW_SCE_p_func101(0x29f8f618U, 0x3e673680U, 0xf44b641cU, 0x202b5bbdU);
                    }
                    else
                    {
                        ...
                        HW_SCE_p_func101(0x6270d736U, 0x43d7731bU, 0x58e26e21U, 0x9536f99dU);
                    }
                }
            }
        }
    ...
    HW_SCE_p_func100(0xfb7780aeU, 0x36cdb7e1U, 0x462e5fffU, 0xb87dd2b1U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x67661c49U, 0x1b58db62U, 0x858970b8U, 0x9440cbe6U);
    ...
    {
        HW_SCE_p_func102(0x10163dedU, 0xc02fdf8aU, 0xca5981f1U, 0xccc245d1U);
        WR1_PROG(REG_14B8H, 0x00000040U);
        WAIT_STS(REG_142CH, 12, 0);

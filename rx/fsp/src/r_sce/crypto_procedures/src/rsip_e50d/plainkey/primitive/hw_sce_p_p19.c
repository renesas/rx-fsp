                                                ...
                                                uint32_t       MAX_CNT)
{
    ...
    HW_SCE_p_func100(0xd0cd408cU, 0x6dded733U, 0x0fb8013aU, 0xd4812b1aU);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x47f541c2U, 0xc8773779U, 0xfbeed1abU, 0x21ce0ff4U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x35f1849eU, 0x713ac9e3U, 0xa70d7476U, 0x9c757fe1U);
        ...
        HW_SCE_p_func100(0x42361afcU, 0x5c11ebc1U, 0x94c7afd6U, 0xafa97967U);
        ...
        HW_SCE_p_func100(0x66f9d9f0U, 0xc51d31cdU, 0xf202075bU, 0xa0a7b3e6U);
        WR1_PROG(REG_1014H, 0x00000250U);
        ...
        WR1_PROG(REG_1A24H, 0x08008107U);
        WAIT_STS(REG_1444H, 31, 1);
        WR4_PROG(REG_1420H, change_endian_long(0x0FFFFFFFU), change_endian_long(0xFFFFFFFFU),
                 change_endian_long(0xFFFFFFFFU), change_endian_long(0xFFFFFFFFU));
        WAIT_STS(REG_1444H, 31, 1);
        WR4_PROG(REG_1420H, change_endian_long(0xFFFFFFFFU), change_endian_long(0xFFFFFFFFU),
                 change_endian_long(0xFFFFFFFFU), change_endian_long(0xFFFFFFFEU));
        WR1_PROG(REG_1400H, 0x00c20021U);
        WAIT_STS(REG_1404H, 30, 0);
        WR1_PROG(REG_143CH, 0x00001800U);

        HW_SCE_p_func100(0x0bad0380U, 0xd510ced0U, 0x4425d998U, 0xd776939eU);
        WR1_PROG(REG_1014H, 0x00000390U);
        ...
        HW_SCE_p_func100(0x51124a63U, 0x93ec97acU, 0x2939a0dbU, 0x19a02a26U);
        WR1_PROG(REG_143CH, 0x00400000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            HW_SCE_p_func100(0x7204c32eU, 0x4bc551d0U, 0x44502ba2U, 0x2e5749adU);
            WR1_PROG(REG_143CH, 0x00400000U);
            ...
            if (CHCK_STS(REG_143CH, 22, 1))
            {
                ...
                HW_SCE_p_func101(0xb11a557aU, 0xefd30608U, 0x49a831f1U, 0x4bd2a55cU);
            }
            else
            {
                WR1_PROG(REG_1014H, 0x000003e0U);
                ...
                WR1_PROG(REG_1A24H, 0x08008107U);
                WAIT_STS(REG_1444H, 31, 1);
                WR4_PROG(REG_1420H, change_endian_long(0x2B832480U), change_endian_long(
                             0x4FC1DF0BU), change_endian_long(0x2B4D0099U), change_endian_long(0x3DFBD7A7U));
                WAIT_STS(REG_1444H, 31, 1);
                WR4_PROG(REG_1420H, change_endian_long(0x2F431806U), change_endian_long(
                             0xAD2FE478U), change_endian_long(0xC4EE1B27U), change_endian_long(0x4A0EA0B0U));
                WR1_PROG(REG_1400H, 0x00c20021U);
                WAIT_STS(REG_1404H, 30, 0);
                WR1_PROG(REG_143CH, 0x00001800U);
                ...
                HW_SCE_p_func101(0x5d4ce8e9U, 0x33272ebbU, 0x36afe1cdU, 0xf76ea155U);
            }

            HW_SCE_p_func101(0xc3d3a098U, 0xcb32307cU, 0xa5c90a74U, 0x47b0408bU);
        }
        else
        {
            HW_SCE_p_func101(0x5b8092e3U, 0xd9fd581dU, 0xb00f4c28U, 0x4ec1c725U);
        }
        ...
        HW_SCE_p_func100(0x34e72a34U, 0x4493cb7fU, 0x1c776843U, 0xca31c71fU);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x277b3edcU, 0xa00957a1U, 0x0b712c5aU, 0x4058a74cU);
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        else
        {
            ...
            HW_SCE_p_func100(0x60047020U, 0x19dbb0eeU, 0xdcc5096fU, 0x15f54baeU);
            WR1_PROG(REG_143CH, 0x00400000U);
            ...
            if (CHCK_STS(REG_143CH, 22, 1))
            {
                ...
                HW_SCE_p_func101(0xa4ca0decU, 0x5370332bU, 0xd8d408f3U, 0x8b42c6cfU);
            }
            else
            {
                WR1_PROG(REG_1014H, 0x00000070U);
                ...
                HW_SCE_p_func101(0xbe21e34aU, 0x4fb0a0e6U, 0xcee63d7bU, 0x74ffd053U);
            }
            ...
            for (iLoop = 0U; iLoop < 256U; iLoop++)
            {
                ...
                HW_SCE_p_func101(0x26d0114bU, 0x6fe0e752U, 0x7de11635U, 0x9b058de1U);
                HW_SCE_p_func402();
                ...
                HW_SCE_p_func101(0x19654b47U, 0x9d6fd678U, 0x99643d9fU, 0x452680f7U);
            }
            ...
            HW_SCE_p_func100(0x2c66e13eU, 0x79668159U, 0x5abffcd1U, 0xc06ba518U);
            ...
            for (iLoop = 0U; iLoop < 256U; iLoop++)
            {
                ...
                HW_SCE_p_func101(0x6f362048U, 0x3a4f4cafU, 0xd2a4550aU, 0xbb09fa87U);
                HW_SCE_p_func402();
                ...
                HW_SCE_p_func101(0x3c0dbc39U, 0x24427a8dU, 0x60092598U, 0x38a1901eU);
            }
            ...
            HW_SCE_p_func100(0x890d0e37U, 0x95dc78c6U, 0x07a07badU, 0xb56ddb13U);
            WR1_PROG(REG_1014H, 0x00000250U);
            WR1_PROG(REG_1018H, 0x000002a0U);
            WR1_PROG(REG_101CH, 0x00000070U);
            WR1_PROG(REG_1020H, 0x000002f0U);
            ...
            HW_SCE_p_func100(0xc7e6a0ccU, 0xfcfbedfaU, 0x5ea90254U, 0x3854a346U);
            WR1_PROG(REG_143CH, 0x00400000U);

            if (CHCK_STS(REG_143CH, 22, 1))
            {
                HW_SCE_p_func102(0x2dc9a0bcU, 0xccb6e0f2U, 0x807a8969U, 0xc25bd871U);
                WR1_PROG(REG_14BCH, 0x00000040U);
                WAIT_STS(REG_142CH, 12, 0);
            ...
            {
                HW_SCE_p_func102(0xf1d62f7aU, 0xe56f65f0U, 0xc304e9bdU, 0xdee060b8U);
                WR1_PROG(REG_14BCH, 0x00000040U);
                WAIT_STS(REG_142CH, 12, 0);

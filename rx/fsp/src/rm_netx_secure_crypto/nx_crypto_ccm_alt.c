...
#include "nx_crypto_ccm.h"
    ...
    (0U == BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED) || (0U == BSP_FEATURE_RSIP_RSIP_E31A_SUPPORTED) || \
    (0U == BSP_FEATURE_RSIP_RSIP_E11A_SUPPORTED))
/**************************************************************************/
/*                                                                        */
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
                                                ...
                                                UINT length, UCHAR *iv, USHORT icv_len, USHORT block_size)
{
    ...
    UINT ret = sce_nx_crypto_ccm_encrypt_init((NX_CRYPTO_AES *) crypto_metadata,
                                              additional_data, /* pointers to AAD */
                                              additional_len, /* length of AAD */
                                                  ...
                                                  UCHAR *input, UCHAR *output, UINT length, UINT block_size)
{
    ...
    UINT ret = sce_nx_crypto_ccm_encrypt_update ((NX_CRYPTO_AES *)crypto_metadata, input, output, length);
...
UINT i;
    ...
    UINT ret = sce_nx_crypto_ccm_encrypt_final ((NX_CRYPTO_AES *) crypto_metadata, icv);
    return ret;
#else
    /* Data authentication.  */
    if (ccm_metadata -> nx_crypto_ccm_icv_length > 0)

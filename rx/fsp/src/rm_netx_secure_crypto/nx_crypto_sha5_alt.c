/**************************************************************************/
/* This file is a copy of the nx_crypto_sha5.c file from NetX Duo         */
/* It has been modified to work with Renesas Secure Crypto Engine.        */
/*  \file nx_crypto_sha5_alt.c                                            */
/**************************************************************************/
...
NX_CRYPTO_KEEP UINT  _nx_crypto_sha512_initialize(NX_CRYPTO_SHA512 *context, UINT algorithm)
{
    ...
    return (sce_nx_crypto_sha512_initialize(context, algorithm));
#else
...
{
#if (1U == NETX_SECURE_CRYPTO_NX_CRYPTO_METHODS_SHA512_ALT)
    return(sce_nx_crypto_sha512_update(context, input_ptr, input_length));
#else
...
{
#if (1U == NETX_SECURE_CRYPTO_NX_CRYPTO_METHODS_SHA512_ALT)
    return (sce_nx_crypto_sha512_digest_calculate (context, digest, algorithm));
#else
...
/*                                                                        */
/**************************************************************************/
#if (0U == NETX_SECURE_CRYPTO_NX_CRYPTO_METHODS_SHA512_ALT)
...
#endif /* NETX_SECURE_CRYPTO_NX_CRYPTO_METHODS_SHA512_ALT */

...
/* Define macros that swap the endian for little endian ports.  */
    ...
    #define NX_CRYPTO_CHANGE_ULONG_ENDIAN(arg)                 \
    (arg) = (((arg) >> 24) & 0xFF) | (((arg) >> 8) & 0xFF00) | \
            (((arg) << 8) & 0xFF0000) | (((arg) << 24) & 0xFF000000)
    #define NX_CRYPTO_CHANGE_USHORT_ENDIAN(arg) \
    (arg) = (((arg) >> 8) & 0xFF) | (((arg) << 8) & 0xFF00)
   #elif defined(__CCRX__)             /* CCRX compiler */
    #define NX_CRYPTO_CHANGE_ULONG_ENDIAN(arg)     (arg) = (unsigned long) (__revl(arg))
    #define NX_CRYPTO_CHANGE_USHORT_ENDIAN(arg)    (arg) = (unsigned short) (__revw(arg))
   #endif
  #else

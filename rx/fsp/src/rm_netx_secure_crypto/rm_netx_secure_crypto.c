...
rm_rand_ret_t rand (void)
{
    ...
    return (rm_rand_ret_t) random_number[0];
}
                                                      ...
                                                      uint32_t * actual_output_length)
{
    ...
    if (curve_id == NX_CRYPTO_EC_SECP384R1)
    {
        ...
        (0 == BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED) && (0 == BSP_FEATURE_RSIP_RSIP_E50D_SUPPORTED)
        ...
        /* RSIP-E11A, RSIP-E31A, RSIP-E50D, RSIP-E51A use plain public key */
        NX_CRYPTO_MEMCPY(output, wrapped_key, wrapped_key_length);

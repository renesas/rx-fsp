...
void r_rsip_p97u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    {
        BSWAP_32BIG_C(0x9819cfabU), BSWAP_32BIG_C(0x747d4204U), BSWAP_32BIG_C(0x63d961c2U), BSWAP_32BIG_C(0x21354ad2U),
    };
    ...
    {
        BSWAP_32BIG_C(0xc6eba2cbU), BSWAP_32BIG_C(0xcb67892eU), BSWAP_32BIG_C(0xe63ac3fcU), BSWAP_32BIG_C(0xf423c9ffU),
    };

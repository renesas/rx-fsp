...
void r_rsip_p50u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    {
        BSWAP_32BIG_C(0x538bf3c6U), BSWAP_32BIG_C(0x867ad53cU), BSWAP_32BIG_C(0x1ddb48d0U), BSWAP_32BIG_C(0x2e908d01U),
    };
    ...
    {
        BSWAP_32BIG_C(0x84100af2U), BSWAP_32BIG_C(0x058a3943U), BSWAP_32BIG_C(0xd2160aabU), BSWAP_32BIG_C(0x774e0d6eU),
    };

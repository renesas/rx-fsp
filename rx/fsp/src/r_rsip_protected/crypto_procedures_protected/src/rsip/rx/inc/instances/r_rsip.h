...
/* Internal state buffer size for HMAC */
    ...
    RSIP_CFG_HMAC_SHA3_512_ENABLE
 #define RSIP_PRV_WORD_SIZE_HMAC_INTERNAL_STATE_BUF     (52U)
#else
...
#if RSIP_CFG_KDF_SHA384_ENABLE || RSIP_CFG_KDF_SHA512_ENABLE
 #define RSIP_PRV_BYTE_SIZE_KDF_SHA_BLOCK_BUF           (128U)
#else
 #define RSIP_PRV_BYTE_SIZE_KDF_SHA_BLOCK_BUF           (64U)
#endif

/* Wrapped key buffer sizes for HMAC */
#if RSIP_CFG_HMAC_SHA512_ENABLE || RSIP_CFG_HMAC_SHA512_224_ENABLE || RSIP_CFG_HMAC_SHA512_256_ENABLE || \
    RSIP_CFG_HMAC_SHA3_512_ENABLE
 #define RSIP_PRV_BYTE_SIZE_WRAPPED_KEY_HMAC_BUF        RSIP_BYTE_SIZE_WRAPPED_KEY(RSIP_KEY_TYPE_HMAC_SHA512)
#elif RSIP_CFG_HMAC_SHA384_ENABLE || RSIP_CFG_HMAC_SHA3_384_ENABLE
 #define RSIP_PRV_BYTE_SIZE_WRAPPED_KEY_HMAC_BUF        RSIP_BYTE_SIZE_WRAPPED_KEY(RSIP_KEY_TYPE_HMAC_SHA384)
#elif RSIP_CFG_HMAC_SHA256_ENABLE || RSIP_CFG_HMAC_SHA224_ENABLE || \
    RSIP_CFG_HMAC_SHA3_256_ENABLE || RSIP_CFG_HMAC_SHA3_224_ENABLE
...
/* Block buffer sizes for HMAC */
#if RSIP_CFG_HMAC_SHA3_224_ENABLE
 #define RSIP_PRV_BYTE_SIZE_HMAC_BLOCK_BUF              (144U * RSIP_CFG_HMAC_BUF_BLOCKS)
#elif RSIP_CFG_HMAC_SHA3_256_ENABLE
 #define RSIP_PRV_BYTE_SIZE_HMAC_BLOCK_BUF              (136U * RSIP_CFG_HMAC_BUF_BLOCKS)
#elif RSIP_CFG_HMAC_SHA384_ENABLE || RSIP_CFG_HMAC_SHA512_ENABLE || \
    RSIP_CFG_HMAC_SHA512_224_ENABLE || RSIP_CFG_HMAC_SHA512_256_ENABLE
 #define RSIP_PRV_BYTE_SIZE_HMAC_BLOCK_BUF              (128U * RSIP_CFG_HMAC_BUF_BLOCKS)
#elif RSIP_CFG_HMAC_SHA3_384_ENABLE
 #define RSIP_PRV_BYTE_SIZE_HMAC_BLOCK_BUF              (104U * RSIP_CFG_HMAC_BUF_BLOCKS)
#elif RSIP_CFG_HMAC_SHA3_512_ENABLE
 #define RSIP_PRV_BYTE_SIZE_HMAC_BLOCK_BUF              (72U * RSIP_CFG_HMAC_BUF_BLOCKS)
#else
...
#elif RSIP_CFG_ECC_BRAINPOOLP512R1_ENABLE
 #define  RSIP_PRV_BYTE_SIZE_ECDH_WRAPPED_SECRET_BUF    RSIP_PRV_BYTE_SIZE_ECDH_WRAPPED_SECRET_512
#elif RSIP_CFG_ECC_SECP384R1_ENABLE || RSIP_CFG_ECC_BRAINPOOLP384R1_ENABLE
...
#elif RSIP_CFG_KDF_HMAC_SHA512_ENABLE || RSIP_CFG_KDF_SHA512_ENABLE
...
#elif RSIP_CFG_KDF_HMAC_SHA384_ENABLE || RSIP_CFG_KDF_SHA384_ENABLE
...
#if RSIP_CFG_ECC_SECP521R1_ENABLE || RSIP_CFG_ECC_BRAINPOOLP512R1_ENABLE
...
typedef enum e_rsip_byte_size_wrapped_key
{
    ...
    RSIP_BYTE_SIZE_WRAPPED_KEY_HMAC_SHA3_224 =
        RSIP_BYTE_SIZE_WRAPPED_KEY(RSIP_KEY_TYPE_HMAC_SHA3_224),               ///< HMAC-SHA3-224
    RSIP_BYTE_SIZE_WRAPPED_KEY_HMAC_SHA3_256 =
        RSIP_BYTE_SIZE_WRAPPED_KEY(RSIP_KEY_TYPE_HMAC_SHA3_256),               ///< HMAC-SHA3-256
    RSIP_BYTE_SIZE_WRAPPED_KEY_HMAC_SHA3_384 =
        RSIP_BYTE_SIZE_WRAPPED_KEY(RSIP_KEY_TYPE_HMAC_SHA3_384),               ///< HMAC-SHA3-384
    RSIP_BYTE_SIZE_WRAPPED_KEY_HMAC_SHA3_512 =
        RSIP_BYTE_SIZE_WRAPPED_KEY(RSIP_KEY_TYPE_HMAC_SHA3_512),               ///< HMAC-SHA3-512
...
typedef enum e_rsip_byte_size_encrypted_key
{
    ...
    RSIP_BYTE_SIZE_ENCRYPTED_KEY_HMAC_SHA3_224 =
        RSIP_BYTE_SIZE_ENCRYPTED_KEY(RSIP_KEY_TYPE_HMAC_SHA3_224),               ///< HMAC-SHA3-224
    RSIP_BYTE_SIZE_ENCRYPTED_KEY_HMAC_SHA3_256 =
        RSIP_BYTE_SIZE_ENCRYPTED_KEY(RSIP_KEY_TYPE_HMAC_SHA3_256),               ///< HMAC-SHA3-256
    RSIP_BYTE_SIZE_ENCRYPTED_KEY_HMAC_SHA3_384 =
        RSIP_BYTE_SIZE_ENCRYPTED_KEY(RSIP_KEY_TYPE_HMAC_SHA3_384),               ///< HMAC-SHA3-384
    RSIP_BYTE_SIZE_ENCRYPTED_KEY_HMAC_SHA3_512 =
        RSIP_BYTE_SIZE_ENCRYPTED_KEY(RSIP_KEY_TYPE_HMAC_SHA3_512),               ///< HMAC-SHA3-512

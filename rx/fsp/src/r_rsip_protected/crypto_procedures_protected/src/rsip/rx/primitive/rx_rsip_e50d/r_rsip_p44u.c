...
void r_rsip_p44u (const uint32_t InData_Text[], uint32_t MAX_CNT)
{
    ...
    r_rsip_func_sub025(0x00020061U, 0x40000000U, 0x0e008406U);
    ...
    {
        BSWAP_32BIG_C(0xdd57ef9bU), BSWAP_32BIG_C(0x59e2e322U), BSWAP_32BIG_C(0xc7e72683U), BSWAP_32BIG_C(0xeaebb6d8U),
    };

 ...
 * 
 * Implements @ref rsip_key_injection_api_t::AES128_InitialKeyWrap.
 * 
 ...
 * @retval FSP_ERR_CRYPTO_SCE_FAIL                     MAC anomaly detection.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::AES192_InitialKeyWrap.
 * 
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::AES256_InitialKeyWrap.
 * 
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::AES128_XTS_InitialKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::AES256_XTS_InitialKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::ChaCha20_InitialKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::RSA2048_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::RSA3072_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::RSA4096_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::ECC_secp256r1_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::ECC_secp384r1_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::ECC_secp521r1_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * This API generates 256-bit ECC private key within the user routine.
 * 
 * Implements @ref rsip_key_injection_api_t::ECC_secp256k1_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::ECC_brainpoolP256r1_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::ECC_brainpoolP384r1_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::ECC_brainpoolP512r1_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::ECC_Ed25519_InitialPrivateKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::HMAC_SHA224_InitialKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::HMAC_SHA256_InitialKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::HMAC_SHA384_InitialKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::HMAC_SHA512_InitialKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::HMAC_SHA512_224_InitialKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.
 ...
 * 
 * Implements @ref rsip_key_injection_api_t::HMAC_SHA512_256_InitialKeyWrap.
 *
 * @param[in]  key_injection_type                      Selection key injection type when generating wrapped key
 * @param[in]  p_wrapped_user_factory_programming_key  Wrapped user factory programming key by the Renesas Key Wrap Service.
 *                                                     When key injection type is plain, this is not required and any value can be specified.

...
#define ADC_B_CHANNEL_VALID_FOR_UNIT(channel_mask, unit_id)    ((ADC_B_UNIT_ID_0 == unit_id) ?                       \
                                                                ...
                                                                (ADC_B_UNIT_ID_1 == unit_id) ?                       \
                                                                (channel_mask & BSP_FEATURE_ADC_B_UNIT_1_CHANNELS) : \
                                                                (channel_mask & BSP_FEATURE_ADC_B_UNIT_2_CHANNELS))

#define R_ADC_B0_ADUGTR_UGAIN_INTEGER_Pos       (14)
#define R_ADC_B0_ADUGTR_UGAIN_INTEGER_Msk       (0xC000)
#define R_ADC_B0_ADUGTR_UGAIN_FRACTIONAL_Pos    (0)
#define R_ADC_B0_ADUGTR_UGAIN_FRACTIONAL_Msk    (0x3FFF)
...
typedef enum e_adc_b_unit_id
{
    ...
    ADC_B_UNIT_ID_2 = 2,               ///< ADC Unit ID 2
} adc_b_unit_id_t;
...
typedef enum e_adc_b_unit_mask
{
    ...
    ADC_B_UNIT_MASK_2         = 0x04,  ///< ADC Unit Mask 2
...
typedef enum e_adc_b_gpt_trigger
{
    ...
    ADC_B_GPT_TRIGGER_A14  = 0x00004000, ///< GPT Trigger A14
    ADC_B_GPT_TRIGGER_A15  = 0x00008000, ///< GPT Trigger A15
    ...
    ADC_B_GPT_TRIGGER_B14  = 0X40000000, ///< GPT Trigger B14
    ADC_B_GPT_TRIGGER_B15  = 0X80000000, ///< GPT Trigger B15
} adc_b_gpt_trigger_t;

/** ADC ELC Trigger options */
typedef enum e_adc_b_elc_trigger
{
    ADC_B_ELC_TRIGGER_NONE = 0x00000000, ///< ELC Trigger Disabled
    ADC_B_ELC_TRIGGER_0    = 0x00000001, ///< ELC Trigger 0
    ADC_B_ELC_TRIGGER_1    = 0x00000002, ///< ELC Trigger 1
    ADC_B_ELC_TRIGGER_2    = 0x00000004, ///< ELC Trigger 2
    ADC_B_ELC_TRIGGER_3    = 0x00000008, ///< ELC Trigger 3
    ADC_B_ELC_TRIGGER_4    = 0x00000010, ///< ELC Trigger 4
    ADC_B_ELC_TRIGGER_5    = 0x00000020, ///< ELC Trigger 5
    ADC_B_ELC_TRIGGER_6    = 0x00000040, ///< ELC Trigger 6
    ADC_B_ELC_TRIGGER_7    = 0x00000080, ///< ELC Trigger 7
    ADC_B_ELC_TRIGGER_8    = 0x00000100, ///< ELC Trigger 8
} adc_b_elc_trigger_t;
...
typedef enum e_adc_b_external_trigger
{
    ...
    ADC_B_EXTERNAL_TRIGGER_ADTRG2 = 0X04, ///< External Trigger ADTRG2 Selection
...
typedef enum e_adc_b_converter_state
{
    ...
    ADC_B_CONVERTER_STATE_ADC_2_CALIBRATING  = 3, ///< ADC 2 Internal Circuit and Gain/Offset Calibration
    ADC_B_CONVERTER_STATE_SH_0_2_CALIBRATING = 4, ///< ADC 0 Sample-and-Hold Calibration
    ADC_B_CONVERTER_STATE_SH_4_6_CALIBRATING = 5, ///< ADC 1 Sample-and-Hold Calibration
    ADC_B_CONVERTER_STATE_READY              = 6, ///< Calibration is complete / ADC 0,1,2 are ready
    ADC_B_CONVERTER_STATE_CALIBRATION_FAIL   = 7, ///< Calibration has failed
...
typedef struct st_adc_b_fifo_read
{
    ...
    adc_b_fifo_data_t fifo_data[12];   ///< FIFO data
} adc_b_fifo_read_t;
...
typedef struct st_adc_b_group_cfg
{
    ...
    adc_b_elc_trigger_t      elc_trigger_enable_mask;      ///< ELC Trigger mask
...
typedef struct st_adc_b_isr_cfg
{
    ...
    uint8_t   calibration_end_ipl_adc_2;  ///< Calibration end IPL for A/D converter unit 2
    ...
    uint8_t   conversion_error_ipl_adc_2; ///< Conversion error IPL for A/D converter unit 2
    ...
    uint8_t   fifo_read_ipl_group_5;      ///< FIFO Read threshold request IPL for Group 5
    uint8_t   fifo_read_ipl_group_6;      ///< FIFO Read threshold request IPL for Group 6
    uint8_t   fifo_read_ipl_group_7;      ///< FIFO Read threshold request IPL for Group 7
    uint8_t   fifo_read_ipl_group_8;      ///< FIFO Read threshold request IPL for Group 8
    uint8_t   fifo_read_ipl_group_9;      ///< FIFO Read threshold request IPL for Group 9
    uint8_t   fifo_read_ipl_group_10;     ///< FIFO Read threshold request IPL for Group 10
    uint8_t   fifo_read_ipl_group_11;     ///< FIFO Read threshold request IPL for Group 11
    ...
    uint8_t   overflow_error_ipl_adc_2;   ///< Overflow error IPL for A/D converter unit 2
    ...
    uint8_t   scan_end_ipl_group_5;       ///< Scan End IPL for A/D Group 5
    uint8_t   scan_end_ipl_group_6;       ///< Scan End IPL for A/D Group 6
    uint8_t   scan_end_ipl_group_7;       ///< Scan End IPL for A/D Group 7
    uint8_t   scan_end_ipl_group_8;       ///< Scan End IPL for A/D Group 8
    uint8_t   scan_end_ipl_group_9;       ///< Scan End IPL for A/D Group 9
    uint8_t   scan_end_ipl_group_10;      ///< Scan End IPL for A/D Group 10
    uint8_t   scan_end_ipl_group_11;      ///< Scan End IPL for A/D Group 11
    ...
    IRQn_Type calibration_end_irq_adc_2;  ///< Calibration end IRQ for A/D converter unit 2
    ...
    IRQn_Type conversion_error_irq_adc_2; ///< Conversion error IRQ for A/D converter unit 2
    ...
    IRQn_Type fifo_read_irq_group_9;      ///< FIFO Read threshold request IRQ for Group 9
    IRQn_Type fifo_read_irq_group_10;     ///< FIFO Read threshold request IRQ for Group 10
    IRQn_Type fifo_read_irq_group_11;     ///< FIFO Read threshold request IRQ for Group 11
    ...
    IRQn_Type overflow_error_irq_adc_2;   ///< Overflow error IRQ for A/D converter unit 2
    ...
    IRQn_Type scan_end_irq_group_9;       ///< Scan End IRQ for A/D Group 9
    IRQn_Type scan_end_irq_group_10;      ///< Scan End IRQ for A/D Group 10
    IRQn_Type scan_end_irq_group_11;      ///< Scan End IRQ for A/D Group 11
...
typedef struct st_adc_b_extended_cfg
{
    ...
    union
    {
        uint32_t bits;                 ///< Digital filter selection mask bits
        __PACKED_STRUCT
        {
#if defined(__BIG) && defined(__GNUC__)
            uint32_t                               : 6;
...
#if defined(__BIG) && defined(__GNUC__)
            uint32_t                    : 7;
            uint32_t gpt_disable_sync   : 1;
            uint32_t                    : 5;
            uint32_t adc_2_disable_sync : 1;
            uint32_t adc_1_disable_sync : 1;
            uint32_t adc_0_disable_sync : 1;
            uint32_t                    : 8;
            uint32_t period_cycle       : 8;
#else
            uint32_t period_cycle       : 8;
            uint32_t                    : 8;
            uint32_t adc_0_disable_sync : 1;
...
#if defined(__BIG) && defined(__GNUC__)
            uint16_t         : 4;
            uint16_t fifo_11 : 1;      ///< FIFO enable for group 11
            uint16_t fifo_10 : 1;      ///< FIFO enable for group 10
            uint16_t fifo_9  : 1;      ///< FIFO enable for group 9
    ...
    uint16_t                fifo_interrupt_level[12];           ///< FIFO data threshold interrupt level for groups 0-11
    uint16_t                start_trigger_delay_table[12];      ///< Start trigger delay for groups 0-11
    ...
    uint16_t                sampling_state_table[16];           ///< Sampling State Tables
    ...
    uint32_t                conversion_state;                   ///< ADC 0/1/2 Successive Approximation Time Configuration

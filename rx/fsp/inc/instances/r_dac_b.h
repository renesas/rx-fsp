...
#ifndef BSP_OVERRIDE_DAC_B_OUTPUT_T
typedef enum e_dac_b_output
{
    DAC_B_OUTPUT_EXTERNAL = 0,         ///< DAOUTDIS = 0
    DAC_B_OUTPUT_INTERNAL = 1,         ///< DAOUTDIS = 1
} dac_b_output_t;
#endif
...
{
    bool              output_amplifier_enabled; ///< Output amplifier enabled/disabled.
    dac_b_output_t    internal_output_enabled;  ///< Internal output enable available on selected MCUs.

...
/** There are two different versions of the RX MCU error recovery procedure. */
...
#define I3C_EVENT_STATUS_ADDRESS_HEADER       (0x4)  ///< An Address Header error was detected.

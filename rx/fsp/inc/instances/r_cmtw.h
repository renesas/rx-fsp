...
/** Maximum period value allowed for CMTW peripheral. */
#define CMTW_MAX_PERIOD_32BIT    (UINT32_MAX)

/** Maximum period value allowed for standard CMTW peripheral. */
...
typedef struct st_cmtw_instance_ctrl
{
    ...
    bool                period_count_passed;      // Whether or not one period passed

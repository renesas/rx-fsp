...
typedef enum e_fsp_ip
{
    ...
    FSP_IP_SDHI         = 52,          ///< SD Host Interface
    ...
    FSP_IP_EXDMAC       = 77,          ///< EXDMA Controller
    FSP_IP_ACSE         = 78,          ///< All-Module Clock Stop Mode Enable
    FSP_IP_EXPANSIONRAM = 79,          ///< Expansion RAM
    FSP_IP_ECCRAM       = 80,          ///< ECCRAM
    FSP_IP_STANDBYRAM   = 81,          ///< Standby RAM
    FSP_IP_MMCIF        = 82,          ///< MMC Host Interface
    FSP_IP_TSIP         = 83,          ///< Trusted Secure IP
    FSP_IP_TPU          = 84,          ///< 16-Bit Timer Pulse Unit
    FSP_IP_CMT          = 85,          ///< Compare Match Timer
    FSP_IP_CMTW         = 86,          ///< Compare Match Timer W
    FSP_IP_TMR          = 87,          ///< 8-Bit Timer
    FSP_IP_MTU          = 88,          ///< Multifunction Timer Pulse Unit
    FSP_IP_PPG          = 89,          ///< Programmable Pulse Generator
    FSP_IP_HRPWM        = 90,          ///< High Resolution PWM Waveform Generation Circuit
    FSP_IP_CMPC         = 91,          ///< Comparator C
    FSP_IP_SCI_B        = 92,          ///< Serial Communications Interface
    FSP_IP_I3C          = 93,          ///< I3C Bus Interface
    FSP_IP_SPI_B        = 94,          ///< Serial Peripheral Interface
    FSP_IP_ENDAT        = 95,          ///< EnDat 2.2
    FSP_IP_ENDAT3       = 96,          ///< EnDat 3
    FSP_IP_BISS         = 97,          ///< BiSS-C
    FSP_IP_BISSL        = 98,          ///< BiSS-Line
    FSP_IP_HDSL         = 99,          ///< HIPERFACE DSL
    FSP_IP_AFMT         = 100,         ///< A-format
    FSP_IP_FFT          = 101,         ///< FFT Accelerator
} fsp_ip_t;

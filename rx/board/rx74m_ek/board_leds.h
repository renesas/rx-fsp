 ...
 * @defgroup BOARD_RX74M_EK_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the RX74M_EK board. It includes info on the number of LEDs and which pins are they
 * are on.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RX74M_EK_LEDS) */
